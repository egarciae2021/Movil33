<%@ Control Language="VB" AutoEventWireup="false" Inherits="ExportarExcelGenerico" CodeBehind="ExportarExcelGenerico.ascx.vb" %>
    ...
    <tr>
        <td>
            <div title="Exportar" id="btnExportarExcel" class="btnButton" runat="server" style="width: 33px; cursor: hand; cursor: pointer;">
                <asp:Image alt="Exportar" Style="margin-left: -3px;" AlternateText="Exportar" ID="imgBusqueda" Height="15px" runat="server" ImageUrl="~/Common/Images/Mantenimiento/Excel16.png" />
            </div>
        </td>
    </tr>
</table>
    ...
    <table>
        ...
        <tr>
            <td colspan="2" align="right">
                <input id="btnAceptar" class="btnButton" type="button" style="height: 24px;" runat="server" value="Aceptar" />
                &nbsp;
                <input id="btnCancelar" class="btnButton" type="button" style="height: 24px;" runat="server" value="Cancelar" />
            </td>
        </tr>
    </table>
</div>
