...
//        this.MOV_CAM_ContratoTarifa(p_Contrato.MOV_CAM_ContratoTarifa);
    ...
    this.Guardar = function (p_SatisfactoriaGuardar, p_ErrorGuardar) {
        //var Metodo = raiz("P_Movil/Facturacion/Mantenimiento/Con_Fac_UploadCese.aspx/Guardar");
        var Metodo = raiz("Facturacion/Mantenimiento/Con_Fac_UploadCese.aspx/Guardar");
        var Data = {
...
//        var Metodo = raiz("P_Movil/Facturacion/Mantenimiento/Con_Fac_UploadCese.aspx/Mostrar");
        var Metodo = raiz("Facturacion/Mantenimiento/Con_Fac_UploadCese.aspx/Mostrar");
        var Data = {
