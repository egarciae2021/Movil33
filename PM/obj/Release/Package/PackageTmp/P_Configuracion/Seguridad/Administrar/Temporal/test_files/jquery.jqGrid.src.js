...
var xmlJsonClass = {
	...
	toObj: function(xml) {
		...
		if (xml.nodeType === 1) {
			...
			alerta("unhandled node type: " + xml.nodeType);
		}
		return o;
	},
            ...
            return this.each(function(){
                ...
                var XmlConvert = function (xml,o) {
                    ...
                    if(xmlJsonClass.xml2json && $.jgrid.parse) {
                        ...
                        alerta("xml2json or parse are not present");
                    }
                };
			...
			if ($.ui.multiselect ) {
				if(opts.msel == "multiselect") {
					if(!$.jgrid._multiselect) {
						...
						alerta("Multiselect plugin loaded after jqGrid. Please load the plugin before the jqGrid!");
						return;
					}
