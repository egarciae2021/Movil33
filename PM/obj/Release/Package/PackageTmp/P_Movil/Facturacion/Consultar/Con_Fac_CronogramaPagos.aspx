<%@ Page Language="VB" AutoEventWireup="false" Inherits="P_Movil_Facturacion_Consultar_Con_Fac_CronogramaPagos"
    CodeBehind="Con_Fac_CronogramaPagos.aspx.vb" %>
...
<head runat="server">
    ...
    <script src="../../../Common/Scripts/KendoUI/cultures/kendo.culture.es-PE.min.js" type="text/javascript"></script>
      ...
      <script src="Con_Fac_CronogramaPagos.js" type="text/javascript"></script>
    <%--<script src="<%=UtilitarioWeb.ObtieneVersionArchivoEstatico("Con_Fac_CronogramaPagos.js")%>" type="text/javascript"></script>--%>
</head>
                    ...
                    <td>
                        <table border="0">
                            <tbody>
                                ...
                                <tr>
                                  <td style="color: #003F59; vertical-align: middle; padding-right: 5px;">
                                        <b><span>Descripción</span></b>
                                    </td>
                                    <td colspan="1">
                        <asp:TextBox ID="txtDescripcion" runat="server" Width="180" MaxLength="50"></asp:TextBox>
                    </td>
                      <td style="color: #003F59; vertical-align: middle; padding-right: 5px; width:60px;">T. Motivo</td>
                    <td style=" width:80px;">
                        <asp:DropDownList id="ddlTipoProducto" runat="server" Width="70px">
                            <asp:ListItem Value="-1" Text="Todos"></asp:ListItem>
                            <asp:ListItem Value="2" Text="Línea"></asp:ListItem>
                     ...
                     <td style="color: #003F59; vertical-align: middle; padding-right: 5px;  width:30px">
                                        ...
                                        <td style="padding-right: 10px;">
                                            <asp:TextBox ID="txtImei" runat="server" Width="80px" MaxLength="15" class="" ></asp:TextBox>
                                        </td>    
                                     <td style="color: #003F59; vertical-align: middle; padding-right: 5px;">
                                        <b>Línea</b>
                                    </td>
                                        <td style="padding-right: 10px;">
                                            <asp:TextBox ID="txtLinea" runat="server" Width="80px" MaxLength="50" class="" ></asp:TextBox>
                                        </td>  
                                          <td>      <div id="btnBuscar" class="k-button">
        ...
        <div id="Principal">
            ...
            <div>
                <div id="pInformacionUsuario" class="pMedium">
                    ...
                    <table align="left" style="width: 800px;" runat="server" visible="false">
                        ...
                        <tr height="4px style="display:none;"> <%-- jcamacho ocultado--%>
                            <td colspan="6">
                            </td>
                        </tr>
                        <tr style="display:none;"> <%-- jcamacho ocultado--%>
                            <td align="right" style="color: #003F59; vertical-align: bottom;">
                                <b>Fecha:</b>
                            </td>
