...
function dibujarCharts(dataDistribucion) {
    ...
    if (info.length > 0) {
        ...
        cadenaJson = cadenaJson.replace('"Celular",', '"CEL","Color":"#FE6260",');
        cadenaJson = cadenaJson.replace('"Internacional",', '"DDI","Color":"#EDC911",');
        cadenaJson = cadenaJson.replace('"Otros",', '"Otros","Color":"#8CD4E1",');
...
function graficar(contador) {
    ...
    cadenaJson += '"showYAxisValues": "1","showvalues": "0","seriesnameintooltip": "1","showlegend": "0","caption": "TOP TEN DE COSTO","xAxisName": "","yAxisName": "","numberPrefix": "' + vcSimMon + '",';
