<%@ Page Language="VB" AutoEventWireup="false" Inherits="P_Movil_Historico_His_Plantilla" CodeBehind="His_Plantilla.aspx.vb" %>
...
<body>
    ...
    <script src="<%=UtilitarioWeb.ObtieneVersionArchivoEstatico("His_Plantilla.js")%>" type="text/javascript"></script>
                        ...
                        <div id="pnlFiltroChart">
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td></td>--%>
                                    <td>
                                        <div style="width: 80px;">Tipo de Vista :</div>
                                    </td>
                                    <td>
                                        <select id="ddlTipoVista" style="margin: 10px;">
