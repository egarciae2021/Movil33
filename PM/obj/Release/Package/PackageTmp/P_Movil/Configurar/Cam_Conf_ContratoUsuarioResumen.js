...
function CargarNombreArchivo(Archivo, RutaCompleta) {
    ...
    $("#lblRutaContratoResumen").html(Archivo);
    oSubContrato.RutaSubContratoResumen(RutaCompleta);
    $("#ifContratoResumen").attr("src", raiz(RutaCompleta));
    $("#btnDescargar").button("option", "disabled", false);
}

function ObtieneSubContratoResumen() {
    ...
    return vSubContrato.RutaSubContratoResumen;
}
...
$(function () {
    ...
    function Dimensionar() {
        ...
        $('#ifContratoResumen').css({ "height": Alto - 120 });
    }
    ...
    oSubContrato.InicioResumen($("#hdfIdSubContrato").val());
    ...
    $("#btnDescargar").click(function () {
        window.location = "../../Common/Controladores/DescargarArchivo.ashx?archivo=" + oSubContrato.RutaSubContratoResumen();
    });
