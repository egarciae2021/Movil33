...
$(function () {
    ...
    $("#btnActivar").click(function () {
        if (flagSeleccion) {
            if (RegistroActual.inEstPro == '69') {
                ...
                $.ajax({
                    type: "POST",
                    url: "Conf_DistribucionMinutos_Light.aspx/Validar_Periodo",
    ...
    $("#btnCerrarDist").click(function () {
        if (flagSeleccion) {
            ...
            confirmacion("¿Desea cerrar el periodo?", fnCerrarDistribucion, null, "Confirmación");
        } else {
            alerta("Debe seleccionar un Periodo");
        }
    });

    $("#btnAbrirDist").click(function () {
        if (flagSeleccion) {
            if (RegistroActual.inEstPro != 71) {
                alerta("El periodo debe estar cerrado.");
                return;
            }
            confirmacion("¿Desea abrir el periodo?", fnAbrirDistribucion, null, "Confirmación");
        } else {
            alerta("Debe seleccionar un Periodo");
        }
    });
...
function valida_Cuenta(vcCodCue) {
    $.ajax({
        type: "POST",
        url: "Conf_DistribucionMinutos_Light.aspx/ListarServicioPorCuenta",
...
function Guarda_Periodo() {
    ...
    $.ajax({
        type: "POST",
        url: "Conf_DistribucionMinutos_Light.aspx/GuardarPeriodo",
...
function CambiaOperador() {
    ...
    if ($("#ddlOperador").val() != "-1") {
        ...
        $.ajax({
            type: "POST",
            url: "Conf_DistribucionMinutos_Light.aspx/ListarCuentaPorOperador",
...
function Obtener_Minutos() {
    ...
    $.ajax({
        type: "POST",
        url: "Conf_DistribucionMinutos_Light.aspx/Obtener_Cuenta",
...
function Obtener_Minutos_Nuevo() {

    var Obtener_Cuenta_Data = { idCuenta: $("#hdfidCuenta").val(),
        p_vcCodInt2: F_vcCodInt.toString(),
        p_PolOrga: p_PolOrga.toString(),
        IdSubCuenta: $("#hdfidSubCuenta").val()
    };
    //$("#hdfidSubCuenta").val()
...
function Guarda_Linea(p_vcValue, p_vcNum, p_obj) {
    ...
    $.ajax({
        type: "POST",
        url: "Conf_DistribucionMinutos_Light.aspx/" + vUrl,
...
function Listar_Linea(p_inNiv, p_CodGru, p_CodCC, p_CodOrga, p_inModo) {
    ...
    [
        ...
        { name: 'P_vcNum', index: 'P_vcNum', label: 'Empleado', hidden: false, width: '425px', sortable: false,
            formatter: function (value, options, rData) {
                return "" + rData[2];

            }
        },
        { name: 'P_vcNum', index: 'P_vcNum', label: 'IMEI', hidden: true, width: '100px', sortable: false, align: 'center',
            formatter: function (value, options, rData) {
                return "" + rData[3];

            }
        },
        { name: 'P_vcNum', index: 'P_vcNum', label: 'Modelo Dispositivo', hidden: true, width: '150px', sortable: false,
            formatter: function (value, options, rData) {
                return "" + rData[4];

            }
        },
        { name: 'P_vcNum', index: 'P_vcNum', label: 'Sucursal', hidden: true, width: '120px', sortable: false,
            formatter: function (value, options, rData) {
                return "" + rData[6];
        ...
        { name: 'P_vcNum', index: 'P_vcNum', label: 'Minutos Consumidos', hidden: true, width: '85px', sortable: false, align: 'right',
            formatter: function (value, options, rData) {
    ...
    var tblinea = $("#tbLinea").jqGrid({
        ...
        datatype: function () {
            ...
            var dataGrid = { inPagTam: $('#tbLinea').getGridParam("rowNum"), //Tamaño de pagina
                ...
                inCodTipDis: 0 //$("#ddlModo").val()
            };

            $.ajax({
                url: "Conf_DistribucionMinutos_Light.aspx/Lista_dtLinea", //PageMethod
...
function Listar_LineaDetalle() {
    var tbColumns = [
        ...
        { name: 'Cuenta.dcMonReal', index: 'Cuenta.dcMonReal', label: 'Minutos Consumidos', hidden: true, width: '70px', sortable: false, align: 'right',
            formatter: function (value, options, rData) {
                return "" + parseInt(rData[10]);
        ...
        var tbLineaDetalle = $("#tbLineaDetalle").jqGrid({
            ...
            datatype: function () {
                ...
                var Lista_dtLinea_Data = {
                    ...
                    p_LinExcep: "0",
                    inCodBolPer: $("#hdfidPeriodo").val(),
                    inCodTipDis: "0" //vcModo
                };

                $.ajax({
                    url: "Conf_DistribucionMinutos_Light.aspx/Lista_dtLinea",
...
function Asignar_Valores() {
    ...
    $.ajax({
        type: "POST",
        url: "Conf_DistribucionMinutos_Light.aspx/Asignar_Valores_Temp",
...
function Evaluar_Asignar(index) {
    if (index == 5) { //aplicar aumento
        ...
        if (index == 3 || index == 30) {
            ...
            $.ajax({
                type: "POST",
                url: "Conf_DistribucionMinutos_Light.aspx/Valida_TablaPeriodo",
...
function VerHistorico(p_vcCodLin) {
    ...
    $.ajax({
        type: "POST",
        url: "Conf_DistribucionMinutos_Light.aspx/Listar_Historico",
...
function fnEliminarPeriodo() {
    ...
    $.ajax({
        type: "POST",
        url: "Conf_DistribucionMinutos_Light.aspx/Elimina_Periodo",
...
function Activar_periodo() {
    ...
    $.ajax({
        type: "POST",
        url: "Conf_DistribucionMinutos_Light.aspx/Activar_Periodo",
...
function Cabecera() {
    ...
    var tbHistorico = $("#tbHistorico").jqGrid({
        ...
        colModel: [
            ...
            { name: 'Cuenta.dcMonReal', index: 'Cuenta.dcMonReal', label: 'Minutos Consumidos', hidden: true, width: '80px', sortable: false, align: 'right',
                formatter: function (value, options, rData) {
...
function Lista_Periodo() {
    var tbColumns = [
        ...
        { name: 'vcNomOpe', index: 'vcNomOpe', label: 'Operador', hidden: true, width: '140px', sortable: true,
            formatter: function (value, options, rData) {
                return "" + rData[3];
            }
        },
        ...
        { name: 'vcNomCue', index: 'vcNomCue', label: 'Cuenta', hidden: false, width: '350px', sortable: true,
            formatter: function (value, options, rData) {
        ...
        { name: 'vcNomTipDis', index: 'vcNomTipDis', label: 'Tipo Distribución.', hidden: true, width: '100px',
            formatter: function (value, options, rData) {
                return "" + rData[17];
            }
        },
        ...
        { name: 'vcEstPro', index: 'vcEstPro', label: 'Estado Proceso', hidden: false, width: '100px', align: 'center',
            formatter: function (value, options, rData) {
                return "" + rData[18];
            }
        },
        ...
        { name: 'inLinDistCero', index: 'inLinDistCero', label: 'Líneas Dist Cero', hidden: true, width: '60px', sortable: true, align: 'right',
            formatter: function (value, options, rData) {
                return "" + rData[23];
            }
        },
    ...
    var tbPeriodo = $("#tbPeriodo").jqGrid({
        ...
        datatype: function () {
            ...
            $.ajax({
                type: "POST",
                url: "Conf_DistribucionMinutos_Light.aspx/Listar_Periodo",
...
function Copia_Periodo() {
    ...
    $.ajax({
        type: "POST",
        url: "Conf_DistribucionMinutos_Light.aspx/Copia_Periodo",
...
function VerHistorialPeriodo() {
    ...
    $.ajax({
        type: "POST",
        url: "Conf_DistribucionMinutos_Light.aspx/Listar_TablaPeriodo",
...
function Listar_DistribucionAgrupada(p_vcCodCue, p_vcper, p_vcBus, p_inTipDis) {
    var tbColumns = [
        ...
        { name: 'dcMonReal', index: 'dcMonReal', label: 'Minutos Consumido', hidden: true, width: '80px', sortable: false, align: 'right',
            formatter: function (value, options, rData) {
    ...
    var tbDistAgrup = $("#tbDistAgrup").jqGrid({
        ...
        datatype: function () {
            var Lista_Agrup_Data = { inPagTam: $('#tbDistAgrup').getGridParam("rowNum"), //Tamaño de pagina
                ...
                p_vcCodInt2: (p_Fil_Codint2.length == 0 ? (p_PolOrga == '1' ? F_vcCodInt : '') : p_Fil_Codint2),
                vcGuidNom: $("#hdfGuidNomTabTemp").val(),
                inTipDis: "0", //$("#hdfidTipoDis").val(),
                inCodBolPer: $("#hdfidPeriodo").val()
            };

            $.ajax({
                type: "POST",
                url: "Conf_DistribucionMinutos_Light.aspx/Lista_dtAgrup",
...
function Guardar_Agrupacion() {
    ...
    $.ajax({
        type: "POST",
        url: "Conf_DistribucionMinutos_Light.aspx/Guardar_TipoDistribucion_Tmp",
...
function fnCrearTablaTemporal(vcModo, idCue, vcPer, codBolPer) {
    ...
    $.ajax({
        type: "POST",
        url: "Conf_DistribucionMinutos_Light.aspx/CrearTablaTemporalEdicion",
...
function fnEliminarTablaTemporal() {
    ...
    $.ajax({
        type: "POST",
        url: "Conf_DistribucionMinutos_Light.aspx/EliminarTablaTemporal",
...
function fnActualizarDistribucionDetalle() {
    ...
    $.ajax({
        type: "POST",
        url: "Conf_DistribucionMinutos_Light.aspx/ActualizarDistribucionDetalle",
...
function fnValidarDatosTemporales(vcEvent) {    
    ...
    $.ajax({
        type: "POST",
        url: "Conf_DistribucionMinutos_Light.aspx/ValiddDatosTemporales",
...
function fnQuitarLinea() {
    ...
    $.ajax({
        type: "POST",
        url: "Conf_DistribucionMinutos_Light.aspx/QuitarLinea_DistTemp",
...
function fnEnviarAlOperador() {
    ...
    $.ajax({
        type: "POST",
        url: "Conf_DistribucionMinutos_Light.aspx/EnviarAlOperador",
...
function fnAbrirDistribucion() {
    var AbrirDistribucion_Data = {
    ...
    $.ajax({
        type: "POST",
        url: "Conf_DistribucionMinutos_Light.aspx/AbrirDistribucion",
        data: JSON.stringify(AbrirDistribucion_Data),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (result) {
            if (result.d = '1') {
                alerta("La distribución a sido abierta");
                $("#tbPeriodo").trigger("reloadGrid");
            } else {
...
function fnCerrarDistribucion() {
    ...
    $.ajax({
        type: "POST",
        url: "Conf_DistribucionMinutos_Light.aspx/CerrarDistribucion",
