...
function fnMostrarOficina(Id) {
    ...
    if ($("#ddlCampana").val() == "-1") {
        alerta("La campaña es requerida.");
        $("#bpOficina_txtValorBusqueda").val('');
        return;
    }
...
function CargarNombreArchivo(Archivo, RutaCompleta) {
    ...
    var Data = {
        ...
        Campana: $("#ddlCampana").val(), //Serializa JSON MODELO
...
function fnLimpiar() {
    ...
    $("#dvImportacion").hide();
    //$("#ddlOperador").prop("disabled", true);
    $("#ddlLineaTipo").prop("disabled", false);
...
function CargarPedidos(IdEmpleado, IdOficina) {
    ...
    if ((IdEmpleado == "" && IdOficina == "") || //No se elige oficina o empleado
                ($("#ddlLineaTipo").val() == "-1" || //STAFF
                ($("#ddlLineaTipo").val() == "2" && $("#ddlTipoSolicitudFamilia").val() == "-1") || //Familia Solicitud
                ($("#ddlLineaTipo").val() == "2" && $("#ddlTipoSolicitudFamilia").val() == "2" && $("#ddlCampana").val() == "-1"))) {//Familia Pedidos
        ...
        idSetIntervalPedidos = setInterval(function () {
            ...
            for (j = 0; j < jfin; j++) {
                if (j == $(lstPedidos).length) {
                    ...
                    //                            if($("#ddlLineaTipo").val() == "1" || ($("#ddlLineaTipo").val() == "2" && $("#ddlTipoSolicitudFamilia").val() == "1"))
...
function Dimensionar() {
    if (tbPedido != null) {
        ...
        $("#tbPedido").setGridHeight(Alto - 310); //Alto - 258
...
function AgregoFilaPedido(rowid, data, rowelem) {
    ...
    var i;
    if ($("#ddlLineaTipo").val() == 2) { //formato grilla familia
    ...
    } else if ($("#ddlLineaTipo").val() == 1) { //formato grilla staff
...
function SeleccionoPedido(id) {
    ...
    if ($("#ddlLineaTipo").val() == 1) { //Solicitudes
        ...
        //if (($("#ddlLineaTipo").val() == 2 && (data.Producto2 == '' || data.FechaDespacho != '' || data.IdCorte == '' || data.Despachado == 'SI' || data.IdEstado == "31")) || ($("#ddlLineaTipo").val() == 1 && (data.FechaDespacho != '' || data.Despachado == 'SI'))) {
        if (($("#ddlLineaTipo").val() == 2 && (data.Producto2 == '' || data.FechaDespacho != '' || data.IdCorte == '' || data.Despachado == 'SI' || data.IdEstado == "31")) || ($("#ddlLineaTipo").val() == 1 && (data.FechaDespacho != '' || data.Despachado == 'SI')) || data.EnviadoOperador == 'NO') {
...
$(function () {
    ...
    $("#ddlLineaTipo").change(function () {
        ...
        if ($("#ddlLineaTipo").val() == "1") {//STAFF
            ...
            if ($("#ddlCampana").val() != "-1") {
                CondicionJQueryEmp = 'EMPL_P_vcCODEMP IN (SELECT DISTINCT IdEmpleado FROM [MOV_CAM_v_CampanaPedidoDetalle_' + $("#ddlCampana").val() + '] VI ';
                ...
                CondicionJQueryOfi = 'IdOficina IN (SELECT DISTINCT EM.IdOficina FROM [MOV_CAM_v_CampanaPedidoDetalle_' + $("#ddlCampana").val() + '] VI ';
    ...
    $("#ddlCampana").change(function () {
        if ($("#ddlLineaTipo").val() == 1) { //agregado 07-01-2016 wapumayta
            return;
        }
        if ($("#ddlCampana").val() != "-1") {
            CondicionJQueryEmp = 'EMPL_P_vcCODEMP IN (SELECT DISTINCT IdEmpleado FROM [MOV_CAM_v_CampanaPedidoDetalle_' + $("#ddlCampana").val() + '] VI ';
    ...
    $("#btnGenerarReporte").click(function () {
        var grIdCampana = $("#ddlCampana").val();
...
function fnExportarReporte() {
    ...
    var pagina = "Adm_Reporte.aspx?vcTipRep=" + tipoRep + "&vcTab=" + vcTab + "&inIdCam=" + $("#ddlCampana").val();
