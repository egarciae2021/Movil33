<%@ Page Language="VB" AutoEventWireup="false" Inherits="P_Movil_Administrar_Adm_DistribucionMinutosOrganizacion" Codebehind="Adm_DistribucionMinutosOrganizacion.aspx.vb" %>
...
<head runat="server">
    ...
    <script src="Adm_DistribucionMinutosOrganizacion.js" type="text/javascript"></script>    
...
<body>
    <form id="form1" runat="server">
                ...
                <tr>
                    ...
                    <td valign="middle" style="width:200px">
                        ...
                        <asp:DropDownList ID="ddlBusqueda" runat="server" style="margin-left:15px; font-weight:normal;" Width="150px">
                            ...
                            <asp:ListItem Value="3">Nivel</asp:ListItem>
                            <asp:ListItem Value="4">Centro de Costo</asp:ListItem>
                        </asp:DropDownList>
                    </td>
        ...
        <div>
            <table id="tbOrganizacion"></table>
            <div id="pagerOrganizacion"></div>        
        </div>
    </form>
</body>
</html>