...
$(function () {
    ...
    var Modal = $("#divSeguridad").dialog({
        title: 'Seguridad (Cambio de equipo)',
        height: 160,
        width: 480,
        modal: true,
        resizable: false,
        ...
        if (CodEmp != "") {
            ...
            if ($("#txtNumero").val() != "") {
                $.ajax({
                    ...
                    data: "{'dcNumLin': '" + numero + "'," +
                           "'vcCodEmp': '" + CodEmp + "'}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (result) {
                        if (result.d == "1") {
                            $("#lblMensaje").html("La línea no pertenece al usuario indicado");
                        }
                        else if (result.d == "2") {
                            $("#lblMensaje").html("Ya existe una solicitud para esta línea");
                        }
                        else if (result.d == "3") {
                            ...
                            //Modal.dialog('close');
                            window.location = "Adm_CambioDispositivo.aspx?vcCodEmp=" + CodEmp + "&dcNumLin=" + $("#hdfLinea").val();
                        }
                    },
                ...
                alerta("Ingrese un numero de celular");
                $("#txtNumero").focus();
            }
        }
        else {
    ...
    $("#btnCancelar").click(function () {
        //alerta("Adm_SolicitarDispositivo.aspx?vcTab=Adm_CambioDispositivo&inCod=14&inTip=3&inTipOri=1&vcCodEmp=" + $("#hdfCodEmpleado").val() + "&dcNumLin=" + $("#txtNumero").val());
        //vcCodEmp=A23118&dcNumLin=357774043952901
        window.location.href = "Adm_SolicitarDispositivo.aspx?vcTab=Adm_CambioDispositivo&inCod=14&inTip=3&inTipOri=1";
    });
