<%@ Page Language="VB" AutoEventWireup="false" Inherits="P_Movil_Administrar_Adm_HistorialPagos" Codebehind="Adm_HistorialPagos.aspx.vb" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="Adm_HistorialPagos.js"></script>
</head>
<body>
            ...
            <table border="0">
                <tr>
                    ...
                    <td rowspan="2" valign="middle" style="width:300px;">
                        Periodo:&nbsp;
                            <asp:TextBox ID="txtFechaInicio" runat="server" Width="80px" ReadOnly="true" CssClass="txtFecha"></asp:TextBox>
                            <img id="imgBorrarFechaInicio" alt="" src="../../Common/Images/Mantenimiento/Borrar.png" title="Limpiar fecha" class="imgBtn"/>
                        &nbsp;-&nbsp;
                            <asp:TextBox ID="txtFechaFin" runat="server" Width="80px" ReadOnly="true" CssClass="txtFecha"></asp:TextBox>
                    ...
                    <td rowspan="2" valign="middle" style="width:250px">
                        ...
                        <asp:TextBox ID="txtOperador" runat="server" style="margin-left:15px; font-weight:normal;" 
                                        width="140px" MaxLength="200" Visible="false"></asp:TextBox>
                    </td>
                    <td rowspan="2" valign="middle" style="width:250px">
                        Estado:&nbsp;
                        <asp:DropDownList ID="ddlEstado" runat="server" width="140px"></asp:DropDownList>
