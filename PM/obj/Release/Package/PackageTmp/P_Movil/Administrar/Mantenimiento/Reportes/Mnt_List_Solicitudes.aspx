<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Mnt_List_Solicitudes.aspx.vb" Inherits=".Mnt_List_Solicitudes" %>
...
<head runat="server">
    ...
    <script src="Mnt_List_Solicitudes.js" type="text/javascript"></script>
    <style type="text/css">
        .dvCargandoMnt
        {
    ...
    <div class="dvPanel" style="overflow: auto;">
        <table align="center">
            ...
            <tr>
                ...
                <td style="text-align: left">
                    De : <asp:TextBox ID="txtFechaIni" runat="server" Width="105px" ToolTip="Fecha Inicio" ReadOnly="True"></asp:TextBox>
                    &nbsp; &nbsp; &nbsp; - &nbsp; &nbsp; &nbsp;
                    Hasta: <asp:TextBox ID="txtFechaFin" runat="server" Width="105px" ToolTip="Fecha Fin" ReadOnly="True"></asp:TextBox>
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlEstadoProceso" runat="server"  Width="339px" multiple="multiple" data-placeholder="Seleccione Estados de Proceso...">
                    </asp:DropDownList>
                </td>
                <td>
                    <div id="btnMostrar" class="btnNormal" runat="server" title="Mostrar Reporte" style="float: left">
