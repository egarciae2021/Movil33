<%@ Page Language="VB" AutoEventWireup="false" Inherits="P_Movil_Administrar_Imp_Proceso_52"
    EnableEventValidation="false" CodeBehind="Imp_Proceso_52.aspx.vb" %>
...
<head runat="server">
    ...
    <script src="Imp_Proceso_52.js" type="text/javascript"></script>
</head>
<body>
                    ...
                    <h4 id="BarraNavegacionJQ1_Panel3_O_Item1" runat="server" url="" title="" click=""
                        ...
                        <div style="font-weight: normal; padding-left: 10px; padding-right: 10px;">
                            <table runat="server" border="0">
                                ...
                                <tr id="tbCta" style="display: none">
                                    <td>Cuenta
                                    </td>
                                    <td style="width: 100px;">
                                        <table>
                                        ...
                                        <div id="dvArchivos" class="dvPanel" style="display: none;">
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <asp:Label ID="lblArchivoTitulo" runat="server" Text="Archivo"></asp:Label>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
