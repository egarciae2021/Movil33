<%@ Page Language="VB" AutoEventWireup="false" Inherits="P_Movil_Administrar_Adm_DistribucionMinutosCentroCosto" Codebehind="Adm_DistribucionMinutosCentroCosto.aspx.vb" %>
...
<head runat="server">
    ...
    <script src="Adm_DistribucionMinutosCentroCosto.js" type="text/javascript"></script>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <table id="tbCentroCosto"></table>
            <div id="pagerCentroCosto"></div>
        </div>
    </form>
</body>
</html>
