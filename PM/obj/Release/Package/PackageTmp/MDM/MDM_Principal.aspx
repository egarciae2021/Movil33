<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MDM_Principal.aspx.vb" Inherits=".MDM_Principal" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <script src="<%=UtilitarioWeb.ObtieneVersionArchivoEstatico("MDM_Principal.js")%>" type="text/javascript"></script>
            ...
            <table width="100%" border="0">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-9">
                                                    <select name="ddlTipoVista" id="ddlTipoVista" style="width: 100%;">
                                                        <option value="1">Modelo Dispositivo</option>
                ...
                <tr>
                    <td>
                        ...
                        <%--<div id="dvVista" style="height:100%">
                            <iframe id="ifVista" style="width: 100%; height: 100%; border:0px"></iframe>
                        </div>--%>
                    </td>
                </tr>
            </table>
