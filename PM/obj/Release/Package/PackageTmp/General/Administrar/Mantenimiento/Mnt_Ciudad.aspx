<%@ Page Language="VB" AutoEventWireup="false" Inherits="General_Administrar_Mantenimiento_Mnt_Ciudad" Codebehind="Mnt_Ciudad.aspx.vb" %>
...
<head runat="server">
    ...
    <script src="Mnt_Ciudad.js" type="text/javascript"></script>
</head>
<body>
                            ...
                            <table width="100%">
                                <tr>
                                    <td class="tdEtiqueta">                                        
                                        ...
                                        País</td>
                                    <td>
                                        <asp:TextBox ID="txtPais" runat="server" Width="300px" MaxLength="20"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="tdEtiqueta">
                                ...
                                <tr id="trTienePadre" runat="server">
                                    <td class="tdEtiqueta">
                                        Tiene Padre</td>
                                    <td>
                                        <asp:CheckBox ID="chkPadre" runat="server" Enabled="True" />
                                    </td>
                                </tr>
                                <tr id="trCiudadBase" runat="server">
                                    <td class="tdEtiqueta">
                                        Ciudad Base</td>
                                    <td>
                                        <asp:DropDownList ID="ddlCiudadBase" runat="server" Width="175px"></asp:DropDownList>
                                    </td>
                                </tr>
