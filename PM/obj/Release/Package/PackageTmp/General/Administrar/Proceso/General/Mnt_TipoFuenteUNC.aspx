<%@ Page Language="VB" AutoEventWireup="false"
    Inherits="General_Administrar_Proceso_General_Mnt_TipoFuenteUNC" Codebehind="Mnt_TipoFuenteUNC.aspx.vb" %>
...
<head runat="server">
    ...
    <script src="Mnt_TipoFuenteUNC.js" type="text/javascript"></script>
</head>
<body>
                ...
                <td>
                    <table width="100%">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtNombreFuente" runat="server" Width="200px" MaxLength="50"></asp:TextBox>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtruta" runat="server" Width="400px" MaxLength="150"></asp:TextBox>
                            </td>
                        </tr>
                        <tr style="display:none;">
                            <td>
                        ...
                        <tr style="display:none;">
                            ...
                            <td>
                                <asp:TextBox ID="txtpassword" runat="server" Width="150px" MaxLength="50" 
