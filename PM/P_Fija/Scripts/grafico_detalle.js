function ArmaGrafico(codint, empresa) {
    ...
    var options = {
      ...
      $("#div_ajax3").html('<img src="~/../images/loader.gif">Generando Gráfico...');
    ...
    $.ajax({
        ...
        url: "resumen_datos.aspx/DetallePoblacionAjax",
        success: function (items) {
            txt_detalles2.SetText(items.d);
        },
        cache: false,
        error: function (XMLHttpRequest, textStatus, errorThrown) {
            MostrarErrorAjax(XMLHttpRequest, "DetallePoblacionAjax", errorThrown);
        }
    });
    ...
    $.ajax({
        ...
        data: "{'fecha_consulta':'" + txt_fecha.GetText() + "','codint':'" + codint + "','telefonia':'" + txt_telefonia.GetText() + "'}",
        contentType: "application/json; charset=utf-8",
        url: "resumen_datos.aspx/ArmaGraficoGeneral",
        success: function (items) {
        ...
        cache: false,
        error: function (XMLHttpRequest, textStatus, errorThrown) {
            MostrarErrorAjax(XMLHttpRequest, "ArmaGraficoGeneral", errorThrown);
      }
    });
