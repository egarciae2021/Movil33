<%@ Page Language="VB" AutoEventWireup="false" Inherits="General_Administrar_Mantenimiento_Mnt_Pais" Codebehind="Mnt_Pais.aspx.vb" %>
...
<head runat="server">
    ...
    <script src="Mnt_Pais.js" type="text/javascript"></script>
</head>
<body>
                        ...
                        <td>                    
                            <table width="100%">
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtCodigo" runat="server" Width="70px" MaxLength="8"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="tdEtiqueta">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtNombre" runat="server" Width="300px" MaxLength="35" 
                                            onChange="validarEspaciosEnBlancoAlInicio()"></asp:TextBox>
                                    </td>
                                </tr>
