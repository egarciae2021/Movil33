<%@ Page Language="VB" AutoEventWireup="false" Inherits="General_Administrar_Mantenimiento_Mnt_Compania" Codebehind="Mnt_Compania.aspx.vb" %>
...
<head runat="server">
    ...
    <script src="Mnt_Compania.js" type="text/javascript"></script>
</head>
<body>
                        ...
                        <td>                    
                            <table width="100%">
                                ...
                                <tr style="display: none;">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtCambiarPrefijo" runat="server" Width="300px" MaxLength="15" ></asp:TextBox>
                                    </td>
                                </tr>
