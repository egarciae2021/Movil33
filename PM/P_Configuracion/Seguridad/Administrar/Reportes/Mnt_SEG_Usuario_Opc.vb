...
Public Class Mnt_SEG_Usuario_Opc
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Mnt_SEG_Usuario_Opc.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMnt_SEG_Usuario_Opc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Mnt_SEG_Usuario_Opc = New Mnt_SEG_Usuario_Opc()
        rpt.Site = Me.Site
        Return rpt
    End Function
