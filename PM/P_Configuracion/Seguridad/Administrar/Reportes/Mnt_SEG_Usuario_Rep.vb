...
Public Class Mnt_SEG_Usuario_Rep
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Mnt_SEG_Usuario_Rep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMnt_SEG_Usuario_Rep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Mnt_SEG_Usuario_Rep = New Mnt_SEG_Usuario_Rep()
        rpt.Site = Me.Site
        Return rpt
    End Function
