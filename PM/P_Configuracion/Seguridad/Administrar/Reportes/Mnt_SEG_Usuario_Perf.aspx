<%@ Page Language="VB" AutoEventWireup="false" Inherits="_Mnt_SEG_Usuario_Perf" Codebehind="Mnt_SEG_Usuario_Perf.aspx.vb" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <CR:CrystalReportSource runat="server" ID="crUsuario">
                    ...
                    <Report FileName="Mnt_SEG_Usuario_Perf.rpt"></Report>
