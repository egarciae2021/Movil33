...
fnAbrirMisReportes = function () {
    var $width = 420;
    var $height = 350;
    var $Pagina = 'Con_MisReportes.aspx?Pivot=Organizacion_General&Tipo=2&Multiple=1';
...
fnNuevaConsulta = function () {
    $("#global").hide(300, function () {
        ...
        //window.parent.$("#dvCargando").show();
        window.location.href = 'PivotReporteOrganizacional_General.aspx?reportenuevo=1';
    });
};

fnNuevaConsulta_PorPlanes = function () {
    $("#global").hide(300, function () {
        window.top.MostrarLoading();
        window.location.href = 'PivotReporteOrganizacional_PorPlan.aspx';
    });
};
