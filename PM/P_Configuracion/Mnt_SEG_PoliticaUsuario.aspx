<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Mnt_SEG_PoliticaUsuario.aspx.vb" Inherits=".Mnt_SEG_PoliticaUsuario" %>
...
<head runat="server">
 ...
 <link href="../../../Common/Styles/Uniform/default/css/uniform.default.min.css" rel="stylesheet" type="text/css" />
    ...
    <script src="../../../Common/Scripts/Utilitario.js" type="text/javascript"></script>
        ...
        <script src="Mnt_SEG_PoliticaUsuario.js" type="text/javascript"></script>        
<style type="text/css" >
    .ColumGridColor
    {
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:DropDownList ID="ddlValorCambioClavePrimerIngreso" style="display:none;" runat="server">
