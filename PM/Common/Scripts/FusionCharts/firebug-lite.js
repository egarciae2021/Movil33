...
}catch(E){alerta("Firebug Error: Firebug popup was blocked.");
return
}}else{alerta("Firebug Error: Firebug popup was blocked.");
return
...
}else{alerta("Firebug Error: Firebug GUI could not be created.")
}}};
...
}catch(pE){alerta("persist error: "+(pE.message||pE))
