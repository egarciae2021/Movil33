...
////          // check extension
////          //Agregado, Mario Maciso
////          if (String($.fn.MultiFile.options.accept).length > 1) {
////              $.fn.MultiFile.options.accept = $.fn.MultiFile.options.accept.replace(/\W+/g, '|').replace(/^\W|\W$/g, '');
////              $.fn.MultiFile.options.rxAccept = new RegExp('\\.(' + ($.fn.MultiFile.options.accept ? $.fn.MultiFile.options.accept : '') + ')$', 'gi');
////          };

////          //if(MultiFile.accept && v && !v.match(MultiFile.rxAccept))//{//Comentado, Mario Maciso W.
////          if ($.fn.MultiFile.options.accept && v && !v.match($.fn.MultiFile.options.rxAccept))//Agregado, Mario Maciso
