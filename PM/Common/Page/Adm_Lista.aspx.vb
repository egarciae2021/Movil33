...
Partial Class P_Movil_Administrar_Adm_Lista
        ...
        Try
            ...
            If dsCampos.Tables(0).Rows.Count > 0 Then
                For i As Integer = 0 To dsCampos.Tables(0).Rows.Count - 1
                    ...
                    'EDGAR GARCIA 18/10 QUITAR COMENTARIO DE EXCEL ( ERROR POR ACTUALIZACIÓN)
    ...
    Public Shared Function DescargarPlantillaLineas(ByVal tipDescarga As String, ByVal inNiv As Integer) As String
        ...
        Try
            ...
            'Edgar Garcia 18/10/2022 SE CAMBIO DE 2  A 3 POR QUE SE AGREGO LEYENDAS
            Dim xlWorksheet2 = oxlWorkbook.Worksheet(3)
            ...
            ' Edgar Garcia 18/10/2022 quitar comentarios por mejora del excel 
