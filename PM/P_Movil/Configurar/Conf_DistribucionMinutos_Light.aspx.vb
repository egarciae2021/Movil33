...
Partial Class P_Movil_Configurar_Conf_DistribucionMinutos_Light
    ...
    <WebMethod()>
    Public Shared Function GuardarPeriodo(ByVal vcPer As String, ByVal idCue As String, ByVal idTipDis As Integer, ByVal idSubCue As String) As List(Of String)
        Dim oUsuario As ENT_SEG_Usuario = Nothing
        Dim CuentaBolsa As BL_MOV_CuentaBolsaPeriodo = Nothing
        Try
            oUsuario = CType(HttpContext.Current.Session("Usuario"), ENT_SEG_Usuario)
            ...
            resultInsert = CuentaBolsa.Insertar(vcPer, idCue, idTipDis, oUsuario.P_inCod, nGuid, -1)
    ...
    <WebMethod()>
    Public Shared Function Obtener_Cuenta(ByVal idCuenta As String, ByVal p_vcCodInt2 As String, _
                                          ByVal p_PolOrga As String, ByVal IdSubCuenta As String) As List(Of String)
        Dim Cuenta As BL_MOV_Cuenta = Nothing
        ...
        Try
            ...
            For Each dr As DataRow In Cuenta.ListarSubCuenta(idCuenta).Rows
                If dr("F_inCodTipSer").ToString() = "16" Then
    ...
    Public Shared Function ActualizarDistribucionDetalle(ByVal vcCodCue As String, ByVal vcPeriodo As String, ByVal inTipDis As Integer,
                                                         ByVal vcGuidNom As String, ByVal inCodBolPer As Integer, ByVal inCodSubCue As String) As Integer
        Dim Linea As BL_MOV_CuentaBolsaDistribucion = Nothing
        Dim oUsuario As ENT_SEG_Usuario = Nothing
        Try
            oUsuario = CType(HttpContext.Current.Session("Usuario"), ENT_SEG_Usuario)
            ...
            Dim inCodSubCueLight As Integer = -1
            result = Linea.ActualizarDistribucionDetalle(vcCodCue, vcPeriodo, vcGuidNom, inTipDis, oUsuario.P_inCod, inCodBolPer, inCodSubCueLight)
    ...
    <WebMethod()>
    Public Shared Function AbrirDistribucion(ByVal inCodBolPer As Integer, ByVal vcCueCue As String, ByVal vcPeriodo As String) As Integer
        Dim CuentaBolsa As BL_MOV_CuentaBolsaPeriodo = Nothing
        Dim oUsuario As ENT_SEG_Usuario = Nothing
        Try
            oUsuario = CType(HttpContext.Current.Session("Usuario"), ENT_SEG_Usuario)
            ...
            result = CuentaBolsa.DistribucionCuentaBolsa_AbrirPeriodo(inCodBolPer, vcCueCue, vcPeriodo, oUsuario.P_inCod)
