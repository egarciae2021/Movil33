...
Partial Class P_Movil_Pedidos_Registrar_pedidos
    Inherits System.Web.UI.Page

    Protected Sub P_Movil_Pedidos_Registrar_pedidos_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        Try
