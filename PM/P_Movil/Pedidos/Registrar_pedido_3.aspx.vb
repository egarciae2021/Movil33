...
Partial Class P_Movil_Pedidos_Registrar_pedido_3
    Inherits System.Web.UI.Page

    Protected Sub P_Movil_Pedidos_Registrar_pedido_3_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        Try
