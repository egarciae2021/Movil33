...
Partial Class P_Movil_Administrar_Adm_ReposicionDispositivo
   ...
   Public Shared Function EnviaSolicitud(ByVal vcNumLin As String, ByVal inCodModDis As String, ByVal vcCodEmp As String, ByVal vcArchAdj As String) As String
      Try
         ...
         'resultado = Solicitud.Insertar(oLinea, Convert.ToInt32(UtilitarioWeb.TipoSolicitud.Reposicion), oUsuario)
         If resultado <> 0 Then
            ...
            '    String.Format(cuerpo, oEmpleado.vcNom, "Reposición de dispositivo")
