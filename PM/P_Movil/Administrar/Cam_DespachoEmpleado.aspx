<%@ Page Language="VB" AutoEventWireup="false" Inherits="P_Movil_Administrar_Cam_DespachoEmpleado" Codebehind="Cam_DespachoEmpleado.aspx.vb" %>
...
<head id="Head1" runat="server">
    ...
    <script src="Cam_DespachoEmpleado.js" type="text/javascript"></script>
    <%--<script type="text/javascript"></script>--%>
</head>
<body>

    <script src="<%=UtilitarioWeb.ObtieneVersionArchivoEstatico("Cam_DespachoEmpleado.js")%>" type="text/javascript"></script>
    ...
    <form id="form1" runat="server">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <div id="btnGenerarReporte" class="btnNormal dvFamilia" style="display:none;">
                        Reporte
                    </div>
                    <iframe id="ifExcel" style="display:none;"></iframe>
        ...
        <div id="dvUsuario" runat="server">
            ...
            <%--<label id="lblEstadoEmpleado" runat="server" >asdf</label>--%>
        </div>
        ...
        <div id="dvDespachos" style="display:none;">
            ...
            <table id="tbFiltrosPedidos" width="100%">
                <tr>
                    <td align="left" class="chkMarcarTodos">
