<%@ Page Language="VB" AutoEventWireup="false" Inherits="P_Movil_Administrar_Adm_DistribucionMinutosNivel" Codebehind="Adm_DistribucionMinutosNivel.aspx.vb" %>
...
<head runat="server">
    ...
    <script src="Adm_DistribucionMinutosNivel.js" type="text/javascript"></script>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <table id="tbNivel"></table>
            <div id="pagerNivel"></div>
        </div>
    </form>
</body>
</html>
