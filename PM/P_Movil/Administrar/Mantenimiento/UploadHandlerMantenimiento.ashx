<%@ WebHandler Language="C#" Class="UploadHandlerMantenimiento" %>
...
public class UploadHandlerMantenimiento : IHttpHandler
{
    public void ProcessRequest(HttpContext context)
    {
        string strPath = HttpContext.Current.Server.MapPath("~") + "//P_Movil//Administrar//Temporal//Mantenimiento//";
