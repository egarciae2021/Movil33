    ...
    Public Shared Function Guardar(ByVal vcLin As String, ByVal vcCamDim As String, ByVal oLinea As String, ByVal vcAsignacionEmpleado As String,
        ...
        Try
            ...
            If vcLin = "" Then
                ...
                _return = Linea.Insertar(v_oLinea, vcCamDim, vcXMLServAdic, vcAsignacionEmpleado, vcAsignacionDispositivo, vcAsignacionANSIEmpleado, vcAsignacionANSIDispositivo, oUsuario.vcNom).ToString()
                If _return = "0" Then
            ...
            Else
                ...
                Dim ds As DataSet = Linea.Actualizar(v_oLinea, vcCamDim, vcXMLServAdic, vcAsignacionEmpleado, vcAsignacionDispositivo, vcAsignacionANSIEmpleado,
                                                     vcAsignacionANSIDispositivo, oUsuario.vcNom, Convert.ToBoolean(vcLiberarEmpleado),
