...
$(function () {
    ...
    var mydata = [
		        { RowNumber: "1", inCodGru: "2007-10-01", vcGru: "Equipos", vcPol: "Modelo de dispositivos" },
		        { RowNumber: "2", inCodGru: "2007-10-02", vcGru: "Servicios", vcPol: "Plan" }
		    ];
    ...
    var tblGrupo = $("#tblProductos").jqGrid({
        ...
        colModel: [{ name: 'RowNumber', index: 'RowNumber', label: 'RowNumber', hidden: true },
                            ...
                            { name: 'vcPol', index: 'vcPol', label: 'Entidad', hidden: false, width: 300 }
   	                        ],
        pager: "#pager", //Pager.
    ...
    $("#btnAgregarProducto").click(function (event) {
        $('#ifProducto').attr("src", "Mantenimiento/Cam_Mnt_Producto.aspx");
