...
Partial Class P_Movil_Administrar_Cam_DespachoEmpleadoStaff
        ...
        Try
            If Not IsPostBack Then
                ...
                Else
                    ...
                    Dim lstArea = oUsuario.F_vcCodInt.Split(",")

                    Dim vcWhere = ""
                    If (lstArea.Count > 1) Then
                        For Each codigoArea In lstArea
                            vcWhere += " EMPL_CodInt2 like |" + codigoArea + "%| or "
                        Next
                    Else
                        vcWhere = "EMPL_CodInt2 like |" + oUsuario.F_vcCodInt + "%| or "
                    End If
        ...
        Try
            ...
            If Proceso.Insertar_Proceso(CodConfigOrigen, CodProceso, CodProcesoInformacion) Then
                If Proceso.Registrar_ProcesoInformacion(CodProceso, CodProcesoInformacion) Then
                    ...
                    Logger.WriteLog(Nothing, LogLevelL4N.INFO, "Ingresa Procesando_Origen")
