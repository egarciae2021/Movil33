...
Public Class Adm_Rpt_FacturaEmpleado
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Adm_Rpt_FacturaEmpleado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAdm_Rpt_FacturaEmpleado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Adm_Rpt_FacturaEmpleado = New Adm_Rpt_FacturaEmpleado()
        rpt.Site = Me.Site
        Return rpt
    End Function
