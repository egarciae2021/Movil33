...
Public Class Cam_Srp_PedidoDetalle
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Cam_Srp_PedidoDetalle.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCam_Srp_PedidoDetalle
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cam_Srp_PedidoDetalle = New Cam_Srp_PedidoDetalle()
        rpt.Site = Me.Site
        Return rpt
    End Function
