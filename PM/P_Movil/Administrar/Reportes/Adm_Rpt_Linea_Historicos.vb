...
Public Class Adm_Rpt_Linea_Historicos
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Adm_Rpt_Linea_Historicos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAdm_Rpt_Linea_Historicos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Adm_Rpt_Linea_Historicos = New Adm_Rpt_Linea_Historicos()
        rpt.Site = Me.Site
        Return rpt
    End Function
