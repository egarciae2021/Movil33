...
Public Class Adm_Rpt_Comprobantes
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Adm_Rpt_Comprobantes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAdm_Rpt_Comprobantes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Adm_Rpt_Comprobantes = New Adm_Rpt_Comprobantes()
        rpt.Site = Me.Site
        Return rpt
    End Function
