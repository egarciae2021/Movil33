...
Public Class Adm_Rpt_Plan_LineasAgrupadas
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Adm_Rpt_Plan_LineasAgrupadas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAdm_Rpt_Plan_LineasAgrupadas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Adm_Rpt_Plan_LineasAgrupadas = New Adm_Rpt_Plan_LineasAgrupadas()
        rpt.Site = Me.Site
        Return rpt
    End Function
