...
Public Class Adm_Rpt_Linea_AgrupadoPorCCO
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Adm_Rpt_Linea_AgrupadoPorCCO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAdm_Rpt_Linea_AgrupadoPorCCO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Adm_Rpt_Linea_AgrupadoPorCCO = New Adm_Rpt_Linea_AgrupadoPorCCO()
        rpt.Site = Me.Site
        Return rpt
    End Function
