...
Partial Class P_Movil_Facturacion_Sumarios_Sum_Navegacion
    ...
    <WebMethod()>
    Public Shared Function listar(ByVal prPeriodo As String, ByVal prCodigo As String, ByVal prTipo As String, ByVal prTelefonia As String, _
    ...
    <WebMethod()>
    Public Shared Function topTenEmpleadosOrganizacion(ByVal prPeriodo As String, ByVal prCodigo As String, ByVal prTipo As String, ByVal prTelefonia As String, _
        ...
        Try
            ...
            topTenEmpYOrg.Add(navegacion.topTenNivelEmpleado(dtDetalle, prPeriodo, prCodigo, prTipo, prTelefonia, True, prFormatDur))
            topTenEmpYOrg.Add(navegacion.topTenNivelEmpleado(dtDetalle, prPeriodo, prCodigo, prTipo, prTelefonia, False, prFormatDur))
    ...
    <WebMethod()>
    Public Shared Function DetallePorGlobal(ByVal prPeriodo As String, ByVal prCodigo As String, ByVal prTipo As String, ByVal prTelefonia As String, _
    ...
    Sub CargarPeriodos()
        ...
        Try
            ...
            objItem = New ListItem(Left(Format(dtFecha, "MMM/yyyy").ToUpper, 1) & Mid(Format(dtFecha, "MMM/yyyy").ToLower, 2), _
                                      dtFecha.ToString("MMyy"))
            ddlMes.Items.Add(objItem)

            For x As Byte = 1 To 21
                objItem = New ListItem(Left(Format(dtFecha.AddMonths(-x), "MMM/yyyy").ToUpper, 1) & Mid(Format(dtFecha.AddMonths(-x), "MMM/yyyy").ToLower, 2), _
