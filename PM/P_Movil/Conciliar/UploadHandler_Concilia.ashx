<%@ WebHandler Language="C#" Class="UploadHandler_Concilia" %>
...
public class UploadHandler_Concilia : IHttpHandler
{
    public void ProcessRequest(HttpContext context)
    {
        string strPath = HttpContext.Current.Server.MapPath("~") + "//P_Movil//Conciliar//Temporal//";
