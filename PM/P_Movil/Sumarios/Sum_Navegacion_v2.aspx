<%@ Page Language="VB" AutoEventWireup="false" Inherits="P_Movil_Sumarios_Sum_Navegacion_v2"
    CodeBehind="Sum_Navegacion_v2.aspx.vb" %>
...
<body>
    ...
    <script src="<%=UtilitarioWeb.ObtieneVersionArchivoEstatico("Sum_Navegacion_v2.js")%>" type="text/javascript"></script>
        ...
        <div style="width: 1024px; margin: auto;">
            ...
            <table id="filtro" border="0" cellpadding="0" cellspacing="3" align="left" style="margin: 0 auto;">
                <tr>
                    ...
                    <select id="selectTipo">
                        ...
                        <option value="DURACIÓN" selected="selected">Consumo</option>
                    </select>
                    </td>
                    <td style="width: 10px;"></td>
                    <td>Telefonía:
                    ...
                    <td align="center">
                        ...
                        <div id="btnExportar" runat="server" title="Exportar a Excel" style="display: none;">
            ...
            <div id="grids-1" style="float: left; width: 100%; border: 0px dotted gray;">
                ...
                <table style="width: 1024px;">
                    ...
                    <tr>
                        <td align="center">
                            <div id="graficosChart" style="width: 100%; height: 355px; border: 0px dotted gray; clear: both; margin: 2px;">
                                <table border="0" width="100%">
                                    <tr>
                                        <td align="right" style="width: 55%; text-align: right;">
                                            <div id="tops" style="clear: both; border: 0px dotted gray; text-align: center;">
                                                <ul style="border: 0px !important;">
                                                    <li><a id="tabTob-0" href="#tob-0">Top Áreas</a></li>
                                                    <li><a id="tabTob-1" href="#tob-1">Top Empleados</a></li>
                                                </ul>
                                                <div id="tob-0" style="width: 450px; height: 300px;">
                                        ...
                                        <td style="vertical-align: top;">
                                            <div id="charts" style="height: auto; border: 0px dotted gray;">
                                            </div>
                                        </td>
                                    </tr>
                                </table>
            ...
            <br />
            <div id="emptyDatos" class="ocultar" align="center" style="float: left; font-size: medium; color: Gray;">
