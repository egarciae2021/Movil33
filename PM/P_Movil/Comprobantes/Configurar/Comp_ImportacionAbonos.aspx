<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Comp_ImportacionAbonos.aspx.vb" Inherits=".Comp_ImportacionAbonos" %>
...
<head runat="server">
    ...
    <script src="Comp_ImportacionAbonos.js" type="text/javascript"></script>
  
        <style type="text/css">
        .  TablaImportacionDinamicas
        {
...
<body>
    ...
    <div class="dvPanel" style="overflow: auto; width: 700px;">
        <h4 class="tblTitulos">
            Cargo de Comprobante de Equipo</h4 >
    ...
    <div class="dvPanel" style="overflow: auto; width: 700px;" title="Puede ingresar más de un email separados por ';'">
        <h4 style="padding: 0px; margin-top: -5px; color: black" class="tblTitulos">
                Notificación de ejecución de importación</h4>
        <table style="font-family: Arial, Helvetica, Verdana !important;font-size:11px !important;">
            <tr>
                ...
                <td style="padding-left: 15px;">
                    <asp:TextBox runat="server" ID="txtCorreo" Width="500px"></asp:TextBox>
                </td>
