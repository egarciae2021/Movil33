...
Public Class Con_Rpt_Desconocido
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Con_Rpt_Desconocido.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCon_Rpt_Desconocido
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Con_Rpt_Desconocido = New Con_Rpt_Desconocido()
        rpt.Site = Me.Site
        Return rpt
    End Function
