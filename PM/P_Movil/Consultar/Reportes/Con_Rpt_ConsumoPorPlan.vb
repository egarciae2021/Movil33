...
Public Class Con_Rpt_ConsumoPorPlan
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Con_Rpt_ConsumoPorPlan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCon_Rpt_ConsumoPorPlan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Con_Rpt_ConsumoPorPlan = New Con_Rpt_ConsumoPorPlan()
        rpt.Site = Me.Site
        Return rpt
    End Function
