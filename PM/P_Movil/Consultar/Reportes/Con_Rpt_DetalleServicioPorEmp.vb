...
Public Class Con_Rpt_DetalleServicioPorEmp
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Con_Rpt_DetalleServicioPorEmp.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
...
Public Class CachedCon_Rpt_DetalleServicioPorEmp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Con_Rpt_DetalleServicioPorEmp = New Con_Rpt_DetalleServicioPorEmp()
        rpt.Site = Me.Site
        Return rpt
    End Function
