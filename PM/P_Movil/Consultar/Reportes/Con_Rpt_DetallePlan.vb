...
Public Class Con_Rpt_DetallePlan
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Con_Rpt_DetallePlan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCon_Rpt_DetallePlan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Con_Rpt_DetallePlan = New Con_Rpt_DetallePlan()
        rpt.Site = Me.Site
        Return rpt
    End Function
