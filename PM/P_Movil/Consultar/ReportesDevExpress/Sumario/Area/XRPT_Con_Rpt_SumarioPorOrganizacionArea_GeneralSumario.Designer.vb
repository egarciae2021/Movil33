...
Partial Public Class XRPT_Con_Rpt_SumarioPorOrganizacionArea_GeneralSumario
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(XRPT_Con_Rpt_SumarioPorOrganizacionArea_GeneralSumario))
        ...
        Me.MoV_s_IMP_Llamada_SumarioPorOrgArea_GenSumarioTableAdapter1 = New dsReporteConsultasTableAdapters.MOV_s_IMP_Llamada_SumarioPorOrgArea_GenSumarioTableAdapter()
        ...
        Me.XrNumLlaTot.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "MOV_s_IMP_Llamada_SumarioPorOrgArea_GenSumario.inNumLlaTot")})
        ...
        Me.XrDurLlaTop.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "MOV_s_IMP_Llamada_SumarioPorOrgArea_GenSumario.vcDurLlaTot")})
        ...
        Me.TrFija.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "MOV_s_IMP_Llamada_SumarioPorOrgArea_GenSumario.dcDurPromReaLlaLoc")})
        ...
        Me.XrCel.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "MOV_s_IMP_Llamada_SumarioPorOrgArea_GenSumario.dcDurPromReaLlaCel")})
        ...
        Me.XrDdi.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "MOV_s_IMP_Llamada_SumarioPorOrgArea_GenSumario.dcDurPromReaLlaDdi")})
        ...
        '
        'MoV_s_IMP_Llamada_SumarioPorOrgArea_GenSumarioTableAdapter1
        '
        Me.MoV_s_IMP_Llamada_SumarioPorOrgArea_GenSumarioTableAdapter1.ClearBeforeFill = True
        '
        'cfTitulo1
        '
        ...
        '
        'XRPT_Con_Rpt_SumarioPorOrganizacionArea_GeneralSumario
        '
        ...
        Me.DataAdapter = Me.MoV_s_IMP_Llamada_SumarioPorOrgArea_GenSumarioTableAdapter1
        Me.DataMember = "MOV_s_IMP_Llamada_SumarioPorOrgArea_GenSumario"
    ...
    Friend WithEvents MoV_s_IMP_Llamada_SumarioPorOrgArea_GenSumarioTableAdapter1 As dsReporteConsultasTableAdapters.MOV_s_IMP_Llamada_SumarioPorOrgArea_GenSumarioTableAdapter
