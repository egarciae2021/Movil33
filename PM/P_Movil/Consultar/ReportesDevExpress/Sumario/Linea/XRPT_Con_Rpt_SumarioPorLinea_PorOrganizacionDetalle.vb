...
Public Class XRPT_Con_Rpt_SumarioPorLinea_PorOrganizacionDetalle
    ...
    Private Sub Detail_BeforePrint(sender As Object, e As Drawing.Printing.PrintEventArgs) Handles Detail.BeforePrint
        ...
        'LLENANDO COLUMNAS
        If Not IsDBNull(GetCurrentColumnValue("vcNumCel")) Then CodLinea = CType(GetCurrentColumnValue("vcNumCel"), String)
