...
Public Class XRPT_Con_Rpt_SumarioPorFecha_GeneralSumario
    Inherits DevExpress.XtraReports.UI.XtraReport
    Private iContador As Integer = 0
    Dim TotalDuracion As Integer = 0 : Dim TotalCostoProm As Decimal = 0 : Dim TotalLlamada As Integer = 0
    ...
    Private Sub Detail_BeforePrint(sender As Object, e As Drawing.Printing.PrintEventArgs) Handles Detail.BeforePrint
        ...
        Dim NomLin$ = "" : Dim Llamada As Integer = 0 : Dim Duracion As String = ""
        ...
        If Not IsDBNull(GetCurrentColumnValue("vcCodInt")) Then NomLin = CType(GetCurrentColumnValue("vcCodInt"), String)
    ...
    Sub Pintar_Filas()
        ...
        If iContador Mod 2 <> 0 Then
            XrOrganizacion.BackColor = Drawing.Color.FromArgb(196, 220, 255)
        ...
        Else
            XrOrganizacion.BackColor = Drawing.Color.White
