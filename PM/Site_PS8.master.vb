                ...
                If Not IsPostBack Then
                    ...
                    If oRegi.REGI_btMostrarLogoEnCabecera Then
                        ...
                        If UtilitarioWeb.ObtieneMO360() = "1" Then
                            LogoCliente.ImageUrl = "~/Content/mo360/logo_head.png"
                            LogoCliente2.ImageUrl = "~/Content/mo360/logo_head.png"
                    ...
                    Else
                        ...
                        If UtilitarioWeb.ObtieneMO360() = "1" Then
                            logonavbar.Src = "~/Content/mo360/logo_head.png"
                            LogoCliente.ImageUrl = "~/Content/mo360/logo_head.png"
                            LogoCliente2.ImageUrl = "~/Content/mo360/logo_head.png"
                            LogoCliente2.Height = 56
                            LogoCliente2.Width = 200
                    ...
                    script = script + "var misAlertas = " + js.Serialize(Alertas.ObtenerTodasLasAlertas(oUsuario.P_inCod,
                    ...
                    If oUsuario.btReinicia And oUsuario.P_inCod <> 1 Then
