...
Partial Class Site_PCSistel_33
        ...
        Try
            ...
            Else
                ...
                If Not IsPostBack Then
                    ...
                    rep_Productos.DataSource = dtProducto
                    rep_Productos.DataBind()

                    rep_Contenidos.DataSource = Producto.Listar(oUsuario)
                    rep_Contenidos.DataBind()
                    ...
                    Dim vcFilaTitulo = "<tr><td><b>Último acceso</b></td></tr>"
                    If oUsuario.CaracteristicaUsuario.vcTem = "blitzer" Then
                        lblAcceso.Text = "<div id='dvItentos'><table id='miTablaSeguridad' border='0' cellpadding='0' cellspacing='0' style= 'z-index:-1;' >" + vcFilaTitulo + "<tr><td>" & oUsuario.dtFecUltAcceso & "</td></tr>"
                    Else
                        lblAcceso.Text = "<div id='dvItentos'><table id='miTablaSeguridad' class='ui-datepicker-title' border='0' cellpadding='0' cellspacing='0' style= 'z-index:-1;' >" + vcFilaTitulo + "<tr><td>" & oUsuario.dtFecUltAcceso & "</td></tr>"
                    End If
