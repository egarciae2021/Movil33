...
e.grid.datatype="xmlstring",e.grid.datastr=a,c(d).jqGrid(f).jqGrid("setGridParam",{datatype:h})):c(d).jqGrid(f)}else alerta("xml2json or parse are not present")},g=function(a,b){if(a&&"string"==typeof a){var e=!1;c.jgrid.useJSON&&(c.jgrid.useJSON=!1,e=!0);var f=c.jgrid.parse(a);e&&(c.jgrid.useJSON=!0);e=f[b.jsonGrid.config];if(f=f[b.jsonGrid.data]){var g=e.datatype;e.datatype="jsonstring";e.datastr=f;c(d).jqGrid(e).jqGrid("setGridParam",{datatype:g})}else c(d).jqGrid(e)}};switch(a.imptype){case "xml":c.ajax(c.extend({url:a.impurl,
...
e(a.msel,g,"destroy");d.remove();b&&a.done&&a.done.call(c)},msel_opts:{}},b.jgrid.col,a||{});if(b.ui&&b.ui.multiselect&&a.msel=="multiselect"){if(!b.jgrid._multiselect){alerta("Multiselect plugin loaded after jqGrid. Please load the plugin before the jqGrid!");return}a.msel_opts=b.extend(b.ui.multiselect.defaults,a.msel_opts)}a.caption&&d.attr("title",a.caption);if(a.classname){d.addClass(a.classname);g.addClass(a.classname)}if(a.width){b(">div",d).css({width:a.width,margin:"0 auto"});g.css("width",
...
//////function GetIdFinanciamiento(id) {
//////    //obtengo el valor del campo "IdTipoFinanciamiento", 
//////    //que justamente necesito, pero que viene concatenado con "jqg" por defecto de esta librería 
//////    //y el nombre de la tabla donde está el jqGrid. Utilio simplemente un Replace para que sólo 
//////    //me quede el valor de IdTipoFinanciamiento.

//////    if ($("#" + id).is(':checked')) {
//////        var rpta = id.replace("jqg_tblFinanciamiento_", "");
//////        fCargarIdFinanciamiento(rpta);
//////    }
//////    else {
//////        fCargarIdFinanciamiento('');
//////    }
//}
