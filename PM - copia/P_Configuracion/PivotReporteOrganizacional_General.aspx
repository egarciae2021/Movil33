<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PivotReporteOrganizacional_General.aspx.vb" Inherits=".PivotReporteOrganizacional_General" %>
...
<body style="background: #FFFFFF;">
    <script src="<%=UtilitarioWeb.ObtieneVersionArchivoEstatico("PivotReporteOrganizacional_General.js")%>" type="text/javascript"></script>
...
<div class="dvPanel" id="global">     
    <div class="pos_titulos_generales" style="font-size:13px;font-weight:600;">
        Reportes Din&aacute;micos Organizacional General&nbsp; <asp:Label ID="lblNombreReporte" runat="server" Text=" - [Nuevo Reporte]" Visible="true" ></asp:Label>
    </div>
    <br />
        ...
        <table border="0" style="width: 95%" cellpadding="0" cellspacing="0" align="left">
           ...
           <%-- <tr>
                ...
                <td  align="center" style="font-size:13px;font-weight:bold;">
                    Dispositivos y líneas asignadas
                </td>
                <td  align="right">
                        <dx:ASPxButton ID="ptnIrBolsa" runat="server" Text="Lineas por Bolsa" 
                        AutoPostBack="false"
            ...
            <tr>
                <td align="center">--%>
                    <dx:ASPxPivotGrid runat="server" 
                        ...
                        Width="99%" ID="ASPxPivotGrid1" Style="text-align: center;
                        font-weight: 700;" Height="400px" ClientIDMode="AutoID">
                        <BorderBottom BorderStyle="NotSet"></BorderBottom>
                        <Fields>

                            <%--<dx:PivotGridField Area="DataArea" AreaIndex="1" SummaryType="sum" Caption="Linea" FieldName="Cantidad_lineas" ID="fieldLinea" Options-ShowGrandTotal="False"  />--%>
                            <dx:PivotGridField Area="DataArea" AreaIndex="1" SummaryType="sum" Caption="Línea" FieldName="Cantidad_lineas" ID="fieldCntLinea"   />
                            <dx:PivotGridField Area="DataArea" AreaIndex="2" SummaryType="Sum" Caption="Dispositivo" FieldName="Cantidad_Dispositivos" ID="fieldCntDispositivos"  />
                            ...
                            <dx:PivotGridField Area="RowArea" AreaIndex="4" Caption="Sucursal" SummaryType="Count" Visible="True" FieldName="NombreSucursal" ID="fieldNombreSucursal"  Options-ShowGrandTotal="False"/>
                            <dx:PivotGridField Area="RowArea" AreaIndex="5" Caption="Cod. Centro de Costo" SummaryType="Count" Visible="False" FieldName="CodCentroCosto" ID="fieldCodCentroCosto"  Options-ShowGrandTotal="False"/>
                            <dx:PivotGridField Area="RowArea" AreaIndex="6" Caption="Centro de Costo" SummaryType="Count" Visible="True" FieldName="CentroCosto" ID="fieldCentroCosto"  Options-ShowGrandTotal="False"/>
                            <dx:PivotGridField Area="RowArea" AreaIndex="7" Caption="Grupo Empleado" SummaryType="Count" Visible="False" FieldName="GrupoOrigen" ID="fieldGrupoOrigen"  Options-ShowGrandTotal="False"/>

                            <dx:PivotGridField Area="RowArea" AreaIndex="1" Caption="Nivel" SummaryType="Count" Visible="True" FieldName="Nivel" ID="fieldNivel"  Options-ShowGrandTotal="False"/>
                            <dx:PivotGridField Area="RowArea" AreaIndex="2" Caption="Cod.Organización" SummaryType="Count" Visible="False" FieldName="CodOrganizacion" ID="fieldCodOrganizacion"  Options-ShowGrandTotal="False"/>
                            <dx:PivotGridField Area="RowArea" AreaIndex="3" Caption="Organización" SummaryType="Count"  FieldName="Organizacion" ID="fieldOrganizacion"  Options-ShowGrandTotal="False"/>
                            <dx:PivotGridField Area="RowArea" AreaIndex="8" Caption="Empleado" SummaryType="Count" Visible="True" FieldName="Empleado" ID="fieldEmpleado"  Options-ShowGrandTotal="False"/>
...
<%--                            <dx:PivotGridField Area="RowArea" AreaIndex="8" SummaryType="Count" Caption="Tipo Linea" FieldName="TipoLinea" ID="fieldTipoLineaLinea"  Options-ShowGrandTotal="False"/>--%>
...
<%--
                            <dx:PivotGridField Area="RowArea" AreaIndex="10" SummaryType="Count" 
                                Caption="Estado Linea" FieldName="EstadoProcesoLinea" 
                            ...
                            <%--<dx:PivotGridField Area="RowArea" AreaIndex="13" Caption="Tipo Servicio" SummaryType="Count" Visible="False" FieldName="TipoServicio" ID="fieldTipoServicio"  />--%>
                        </Fields>
	...
	if(button != null &amp;&amp; ASPxPivotGrid1 != null) {
		button.SetText((ASPxPivotGrid1.GetCustomizationFieldsVisibility() ? &quot;Ocultar&quot; : &quot;Mostrar&quot;) + &quot; Lista de Campos&quot;);
                        ...
                        <OptionsPager NumericButtonCount="15">
                            ...
                            <Summary AllPagesText="Página: {0} - {1} ({2} items)" Text="Página {0} de {1} ({2} items)">
                            </Summary>
                        </OptionsPager>
...
<%--                </td>
        ...
        <div style="clear:both; width:100%; text-align:right;color:Red;">* Sólo datos de dispositivos y líneas que están asignadas </div>
        ...
        <asp:ObjectDataSource ID="odsOrganizacion" runat="server" TypeName="VisualSoft.Suite80.BL.BL_GEN_Organizacion"
            SelectMethod="ListarPivotOrganizacional_General" 
