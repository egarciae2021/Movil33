...
Partial Class BusquedaOrganizacion
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                ...
                lstCampo = Campo.Listar(_vcTab, 1, 0)
                'Campo.Dispose();
...
#Region "Genera Scripts Cliente"
    ...
    Private Sub ConfigurarGrid(lstCampo As List(Of ENT_ENT_Campo), oEntidad As ENT_ENT_Entidad)
        ...
        For Each oCampo As ENT_ENT_Campo In lstCampo
            ...
            If oCampo.vcNom = "ORGA_P_inCODINT" OrElse oCampo.vcNom = "ORGA_vcNOMORG" Then
                'agregado Jcamacho
                Columna = Columna & Convert.ToString(", hidden: false")
                If oCampo.vcNom = "ORGA_P_inCODINT" Then
                    Columna = Columna & Convert.ToString(", width: 100")
                    Columna = (Columna & Convert.ToString(",  label: '")) + "Código" + "'"
                End If
                If oCampo.vcNom = "ORGA_vcNOMORG" Then
                    Columna = Columna & Convert.ToString(", width: 370")
                    'label: '" + oCampo.vcDes.Replace("'", "\\'") + "'"
                End If
            Else
    ...
    Private Function ObtieneScript_DefinejqGrid() As String
        ...
        sbScript.AppendLine("           var Metodo = raiz('Common/WebService/General.asmx/ListarBusquedaGeneralOrganizacion');")
        ...
        sbScript.AppendLine("       sortname: idTablas, //Default SortColumn")
