...
$.ajax({
    ...
    url: "resumen_datos.aspx/ArmaGraficoDestino2",
    success: function (items) {
        ...
        try {
            ...
            if (items.d == "{}") {
                $("#blanco_grafico_destinos_2").show();
                $("#grafico_destinos_2").hide();
            }
            else {
                $("#blanco_grafico_destinos_2").hide();
                $("#grafico_destinos_2").show();
            }
    ...
    error: function (XMLHttpRequest, textStatus, errorThrown) {
        MostrarErrorAjax(XMLHttpRequest, "ArmaGraficoDestino2", errorThrown);
    }
});
}