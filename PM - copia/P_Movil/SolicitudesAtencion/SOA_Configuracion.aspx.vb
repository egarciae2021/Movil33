...
Partial Class P_Movil_SolicitudesAtencion_SOA_Configuracion
    Inherits System.Web.UI.Page

    Protected Sub P_Movil_SolicitudesAtencion_SOA_Configuracion_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        Try
