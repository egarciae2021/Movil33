...
Public Class Con_Rpt_ResumenServicioPorCelDir
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Con_Rpt_ResumenServicioPorCelDir.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCon_Rpt_ResumenServicioPorCelDir
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Con_Rpt_ResumenServicioPorCelDir = New Con_Rpt_ResumenServicioPorCelDir()
        rpt.Site = Me.Site
        Return rpt
    End Function
