...
Public Class XRPT_Con_Rpt_SumarioPorHora_GeneralDetalle
    ...
    Private iContador As Integer = 0 : Dim SubTotalSrcCostTot As Decimal = 0 : Dim TotalGrupoCosto As Decimal = 0
