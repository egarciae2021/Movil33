...
Public Class XRPT_Con_Rpt_SumarioPorLinea_PorOrganizacionSumario
    ...
    Private Sub Detail_BeforePrint(sender As Object, e As Drawing.Printing.PrintEventArgs) Handles Detail.BeforePrint
        ...
        If Not IsDBNull(GetCurrentColumnValue("vcNumCel")) Then CodLin = CType(GetCurrentColumnValue("vcNumCel"), String)
