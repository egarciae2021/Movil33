...
Partial Public Class XRPT_Con_Rpt_SumarioPorCentroCosto_GeneralSumario
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(XRPT_Con_Rpt_SumarioPorCentroCosto_GeneralSumario))
        ...
        Me.MOV_s_IMP_Llamada_SumarioPorCCO_GenSumarioTableAdapter1 = New dsReporteConsultasTableAdapters.MOV_s_IMP_Llamada_SumarioPorCCO_GenSumarioTableAdapter()
        ...
        Me.XrNumLlaTot.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "MOV_s_IMP_Llamada_SumarioPorCCO_GenSumario.inNumLlaTot")})
        ...
        Me.XrDurLlaTop.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "MOV_s_IMP_Llamada_SumarioPorCCO_GenSumario.vcDurLlaTot")})
        ...
        Me.TrFija.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "MOV_s_IMP_Llamada_SumarioPorCCO_GenSumario.dcDurPromReaLlaLoc")})
        ...
        Me.XrCel.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "MOV_s_IMP_Llamada_SumarioPorCCO_GenSumario.dcDurPromReaLlaCel")})
        ...
        Me.XrDdi.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "MOV_s_IMP_Llamada_SumarioPorCCO_GenSumario.dcDurPromReaLlaDdi")})
        ...
        '
        'MOV_s_IMP_Llamada_SumarioPorCCO_GenSumarioTableAdapter1
        '
        Me.MOV_s_IMP_Llamada_SumarioPorCCO_GenSumarioTableAdapter1.ClearBeforeFill = True
        '
        'cfTitulo1
        '
        ...
        '
        'XRPT_Con_Rpt_SumarioPorCentroCosto_GeneralSumario
        '
        ...
        Me.DataAdapter = Me.MOV_s_IMP_Llamada_SumarioPorCCO_GenSumarioTableAdapter1
        Me.DataMember = "MOV_s_IMP_Llamada_SumarioPorCCO_GenSumario"
    ...
    Friend WithEvents MOV_s_IMP_Llamada_SumarioPorCCO_GenSumarioTableAdapter1 As dsReporteConsultasTableAdapters.MOV_s_IMP_Llamada_SumarioPorCCO_GenSumarioTableAdapter
