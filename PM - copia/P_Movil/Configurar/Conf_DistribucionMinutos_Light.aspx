<%@ Page Language="VB" AutoEventWireup="false" Inherits="P_Movil_Configurar_Conf_DistribucionMinutos_Light"
    CodeBehind="Conf_DistribucionMinutos_Light.aspx.vb" %>
...
<head id="Head1" runat="server">
    ...
    <script src="Conf_DistribucionMinutos_Light.js" type="text/javascript"></script>
...
<body>
    ...
    <div id="dvCargandoDistribucion" style="background-color: White; width: 100%; height: 100%;
        position: fixed; z-index: 1000;">
    </div>
    <div id="dvPeriodoCopiar" style="display: none;">
        <div style="width: 100%; margin-bottom: 10px;">
            Se generará una copia de la distribución seleccionada. La cuenta, tipo de distribución
            y los montos serán duplicados a una nueva disribución.
        </div>
        ...
        <div>
            Periodo a generar:&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="txtPeriodoCopiar" runat="server" CssClass="MESANHO" MaxLength="7"
                Width="100px"></asp:TextBox>
        </div>
    </div>
    <!-- DIV FILTRO ESTADOS -->
    <div id="dvEstadoPeriodo" class="dvPanel" style="display: none; width: 75px; height: 55px;
        position: absolute; left: 0px; top: 0px; z-index: 999999;">
    ...
    <!-- ========================================================================================
            DIV ORGANIZACION
    ========================================================================================-->
    <div id="dvFiltros" class="dvPanel" style="display: none; width: 340px; height: 325px;
        position: absolute; left: 0px; top: 0px; z-index: 999999;">
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td>
                    <input id="chOmitir" type="checkbox" />
                    <label id="lblomitir" for="lblomitir_" runat="server">
                        Omitir Registros sin empleado asociado
                    </label>
                </td>
                <td>
            ...
            <tr>
                <td colspan="3">
                    <div id="dvOrganizacion" class="dhtmlxTree dvPanel" style="width: 320px; height: 260px;
                        overflow: auto;">
                    </div>
                </td>
            </tr>
            <tr id="trFiltroMinAsig" style="display: none;">
                <td colspan="3" style="padding-top: 5px;">
                    <asp:CheckBox ID="chkCantMinAsig" Text="Mostrar líneas con distribución menor o igual a:"
                        runat="server" />
                    ...
                    <div id="btnAplicarFiltro" runat="server" class="btnNormal" style="float: right;
                        height: 21px;" title="Aplicar filtros">
            ...
            <td>
                <cc1:TabJQ ID="tabOpciones" runat="server" CssClass="tabs" Style="margin: 0px; padding: 0px;
                    ...
                    <cc1:ContenedorTabJQ ID="tabDetalle" Titulo="Detalle" CssClass="dvTabContenido" Height="100%">
                        <table id="tbVerPeriodo" style="width: 930px; margin: 4px; padding: 4px;" border="0"
                            align="left">
                            <tr>
                                <td style="padding-right: 10px; width: 120px;">
                                    <table id="dvAcciones" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td>
                                ...
                                <td style="padding-right: 10px; width: 80px;">
                                    <table id="dvEstado" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td>
                                ...
                                <td style="padding-right: 10px; width: 120px;">
                                    <table id="dvAvanzada" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td>
                                ...
                                <td style="padding-right: 10px; width: 80px;">
                                    <table id="dvProceso" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <div id="btnCerrarDist" class="btnNormal" title="Cerrar Periodo">
                                                    <asp:Image ID="Image14" runat="server" Height="16px" ImageUrl="~/Common/Images/Mantenimiento/padlock_closed.ico" />
                                                </div>
                                            </td>
                                            <td>
                                                <div id="btnAbrirDist" class="btnNormal" title="Abrir Periodo">
                                                    <asp:Image ID="Image6" runat="server" Height="16px" ImageUrl="~/Common/Images/Mantenimiento/padlock_open.ico" />
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:DropDownList ID="ddlFiltroEstPro" runat="server" Style="display: none;" Width="120">
                                                </asp:DropDownList>
                                                <asp:DropDownList ID="ddlFiltroTipDis" runat="server" Style="display: none;" Width="120">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                    </table>
                    ...
                    <cc1:ContenedorTabJQ ID="tabEditar" Titulo="Editar Periodo" CssClass="dvTabContenido"
                        Height="100%">
                        <div id="Div1" style="float: left;">
                            <div class="dvPanel" style="margin-left: 5px; margin-top: 10px; padding: 2px; float: left;
                                height: 60px;">
                                ...
                                <table style="position: relative; top: -13px;">
                                    <tr>
                                        ...
                                        <td id="tddtPeriodo">
                                            <asp:TextBox ID="txtPeriodo" onkeypress="return isNumberKey(event)" runat="server"
                                                CssClass="MESANHO" Width="140px" MaxLength="7"></asp:TextBox>
                                        </td>
                                        <td align="left">
                                            <%--Tipo Dist.--%>
                                        </td>
                                        <td>
                                            <div style="display: none;">
                                                ...
                                                <asp:DropDownList ID="ddlTipoDist" runat="server" Width="210px">
                                                </asp:DropDownList>
                                                <asp:Image ID="imgEditTipoDist" runat="server" CssClass="imgBtn" ImageUrl="~/Common/Images/Mantenimiento/edit_16x16.gif"
                                                    ToolTip="Editar Tipo de Distribución" />
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:DropDownList ID="ddlCuenta" runat="server" Width="210">
                                            </asp:DropDownList>
                                            <asp:Image ID="imgDetCuenta" runat="server" CssClass="imgBtn" ImageUrl="~/Common/Images/Mantenimiento/VerDetalle.png"
                                                ToolTip="Ver Detalle Cuenta" />
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            <div id="dvPanelFiltros" class="dvPanel" style="margin-left: 5px; margin-top: 10px;
                                padding: 2px; float: left; height: 60px;">
                                <span style="position: relative; top: -17px; left: 0px; background-color: White;
                                ...
                                <table style="position: relative; top: -13px;">
                                    <tr>
                                        ...
                                        <td id="tbModo">
                                            <asp:DropDownList ID="ddlModo" runat="server" Width="140px" Style="position: relative;
                                                bottom: 4px;">
                                            </asp:DropDownList>
                                            <asp:Image ID="imgAsignar" runat="server" CssClass="imgBtn" ImageUrl="~/Common/Images/Mantenimiento/Calc_24x24.png"
                                                ToolTip="Asignar Valores" Style="position: relative; top: 4px; display: none;" />
                                        ...
                                        <td>
                                            <table id="tbFiltrosExtras" style="display: none;">
                                                <tr>
                                                    ...
                                                    <td style="width: 65px;">
                                                        <label id="lblLinExcep" for="chkLinExcep" title="Mostrar líneas con una asignación diferente a la distribuida mediante el tipo de distribución">
                                                            Líneas con excepciones</label>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                                ...
                                                <tr valign="middle">
                                                    <td>
                                                        <asp:TextBox ToolTip="Buscar por Línea, Empleado o IMEI &#13; (presionar ENTER para buscar)"
                                                            ID="txtFiltro" runat="server" Width="130" MaxLength="40"></asp:TextBox>
                                                    </td>
                                                    <td>
                                ...
                                <table style="position: relative; top: -13px;">
                                    <tr>
                                        <td>
                                            ...
                                            <div id="btnExportar" class="btnNormal" runat="server" title="Genera archivo excel de líneas, sus datos y la asignación de minutos correspondiente"
                                                click="AgregarRegistro">
                                                <table cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td>
                                                            <asp:Image ID="imgEliminar" runat="server" ImageUrl="~/Common/Images/Mantenimiento/BajarArchivo.png" />
                                                        </td>
                                                        <td>
                                                            &nbsp;&nbsp;<a>Exportar</a>
                                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div id="btnImportar" class="btnNormal" runat="server" title="Subir archivo al servidor"
                                                click="EditarRegistro">
                                                <table cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td>
                                                            <asp:Image ID="Image5" runat="server" ImageUrl="~/Common/Images/Mantenimiento/SubirArchivo.png" />
                                                        </td>
                                                        <td>
                                                            &nbsp;&nbsp;<a>Importar</a>
                                                        </td>
                        ...
                        <div id="dvLeyendaGrilla" style="float: left; margin-top: 5px; margin-left: 10px;
                            width: 100%; display: none;">
                            <div id="dvLeyendaAlta" class="Leyenda" style="background: #BCC1F4;">
                            </div>
                            <div style="float: left; margin-left: 3px; margin-right: 20px;">
                                <label id="lblLeyendaAlta">
                                </label>
                            </div>
                            <div id="dvLeyendaBaja" class="Leyenda" style="background: #FFA7A7;">
                            </div>
                            <div style="float: left; margin-left: 3px; margin-right: 20px;">
                                <label id="lblLeyendaBaja">
                                </label>
                            </div>
                            <div id="dvLeyendaDifDist" class="Leyenda" style="background: #9FE59A;">
                            </div>
                            <div style="float: left; margin-left: 3px; margin-right: 20px;">
                                <label id="lblLeyendaDifDist">
                                </label>
                            </div>
                        ...
                        <table style="width: 915px; margin: 4px; padding: 4px;" border="0" cellpadding="0"
                            cellspacing="0">
                            <tr>
                                <td colspan="10">
                                    <!-- LINEAS -->
                                    ...
                                    <div id="dvDistAgrup" style="display: none;">
                                        <table id="tbDistAgrup">
                                        </table>
                                        <div id="pagerDistAgrup">
                                        </div>
                                    </div>
                                    <!-- TOTALES -->
                                    <div id="tbTotales" style="margin: 0px !important; padding: 5px !important; display: none;
                                        text-align: center">
                                        <table width="100%" style="margin-top: 8px;" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="color: #0431B4">
                                                    Cuenta Bolsa
                                                </td>
                                                <td>
                                                    <%--<div class="dvPanel" style="margin:0px !important; padding:3px !important;" >--%>
                                                    <div class="dvPanel dvTotal">
                                                        <label id="lblCuentaBolsa" style="color: #0431B4">
                                                            0</label>
                                                    </div>
                                                </td>
                                                <td style="color: #B18904">
                                                    Distribución Vigente
                                                </td>
                                                <td>
                                                    <div class="dvPanel dvTotal">
                                                        <label id="lblUltAsignacion" style="color: #B18904">
                                                            0</label>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="dvPanel dvTotal" style="display: none;">
                                                        <label id="lblConsumido" style="color: #0489B1;">
                                                            0</label>
                                                    </div>
                                                </td>
                                                <td style="color: #088A08">
                                                    Distribuido
                                                </td>
                                                <td>
                                                    <div class="dvPanel dvTotal">
                                                        <label id="lblTemporal" style="color: #088A08">
                                                            0</label>
                                                    </div>
                                                </td>
                                                <td>
                                                    <label id="lblDisponible_" style="color: #8E236B">
                                                        Disponible</label>
                                                </td>
                                                <td>
                                                    <div id="dvFondoDisponible" class="dvPanel dvTotal">
                                                        <label id="lblDisponible" style="color: #8E236B">
                                                            0</label>
                                                    </div>
                                                </td>
                                            </tr>
    ...
    <div id="dvExportacionImportacion" style="display: none; padding: 0px; margin: 0px;
        ...
        <iframe id="ifExportacionImportacion" runat="server" scrolling="no" frameborder="0"
    ...
    <div id="dvLineaDetalle" style="display: none; padding: 0px; margin: 0px;">
        <table>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtFiltroDetalle" ToolTip="(presionar ENTER para buscar)" runat="server"
        ...
        <table id="tbLineaDetalle">
        </table>
        <div id="pagerLineaDetalle">
        </div>
        <div id="Div2" style="float: left; margin-top: 10px; margin-left: 10px;">
            <div id="Div3" class="Leyenda" style="background: #BCC1F4;">
            </div>
            <div style="float: left; margin-left: 3px; margin-right: 20px;">
                <label id="Label6">
                    Línea nueva</label>
            </div>
            <div id="Div4" class="Leyenda" style="background: #FFA7A7;">
            </div>
            <div style="float: left; margin-left: 3px; margin-right: 20px;">
                <label id="Label8">
                    Línea de baja</label>
            </div>
            <div id="Div5" class="Leyenda" style="background: #9FE59A;">
            </div>
            <div style="float: left; margin-left: 3px; margin-right: 20px;">
                <label id="Label9">
                    Excepción de distribución</label>
            </div>
        </div>
    </div>
    <!-- ========================================================================================
    ...
    <div id="dvValidaProcesar" style="display: none; padding: 5px; margin: 5px;">
        <table>
            <tr>
                <td colspan="2">
                    Debe seleccionar un servicio, al cual se aplicará los valores asignados
                </td>
            </tr>
            <tr>
                <td>
    ...
    <div id="dvDetalleCuenta" style="display: none; padding: 0px; margin: 0px;">
        <div class="ui-state-default ui-corner-all" style="padding: 4px; margin-top: 5px;
        ...
        <iframe id="ifDetalleCuenta" runat="server" frameborder="0" style="padding: 0px;
            margin: 0px;"></iframe>
    </div>
    <!-- ========================================================================================
            ...
            <div class="dvPanel" style="margin: 0px !important; padding: 10px !important;">
                <table align="center" style="width: 100%;" border="0">
                    ...
                    <tr style="height: 25px;">
                        <td>
                            <input id="ch_1" type="radio" checked="checked" onclick="Evaluar_Asignar(1)" />
                        </td>
                        <td style="width: 220px;" align="left">
                            <label id="Label1" style="color: navy" onclick="Evaluar_Asignar(10)">
                                Cantidad fija</label>
                        </td>
                        <td>
                            &nbsp;&nbsp;
                        ...
                        <td>
                            <input id="txt_CantidadFija" type="text" style="width: 30px; text-align: right" maxlength="4" />
                        </td>
                    </tr>
                    <!-- CONSUMO REAL (Ocultado hasta la próxima mejora)-->
                    <tr style="height: 25px;">
                        <td>
                            <input id="ch_3" type="radio" onclick="Evaluar_Asignar(3)" />
                        </td>
                        <td align="left">
                            <table cellspacing="0" border="0" cellpadding="0">
                                <tr>
                                    <td>
                                        <label id="Label3" style="color: navy;" onclick="Evaluar_Asignar(30)">
                                            Promedio Sugerido</label>
                                    </td>
                                    <td>
                                        &nbsp;
                                    </td>
                                    ...
                                    <td>
                                        <label id="lblPeriodosSeleccionados" style="font-style: italic; font-size: smaller;">
                                        </label>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <td>
                            <div id="btnPeriodosImportados" class="btnNormal" runat="server" style="height: 20px;"
                                title="Ver periodos de consumo real">
                                ...</div>
                        </td>
                    </tr>
                    <!-- PROMEDIO PONDERADO -->
                    <tr style="height: 25px;">
                        <td>
                            <input id="ch_6" type="radio" onclick="Evaluar_Asignar(6)" />
                        </td>
                        <td align="left">
                            <label id="lblEvaluarAsignar" style="color: navy" onclick="Evaluar_Asignar(60)">
                                Distribución según : Minutos Bolsa / N° líneas</label>
                        </td>
                        <td>
                        </td>
                        <td>
                            <input title="Minutos" id="txtCalculo" type="text" style="width: 30px; text-align: right"
                                maxlength="4" value="0" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <label id="Label7" style="color: navy" for="chkTipCalcProm">
                                Omitir líneas sin empleado asociado</label>
                        </td>
                    </tr>
                    <!-- MINUTOS ASIGNADOS -->
                    <tr style="height: 25px;">
                        <td>
                            <input id="ch_4" type="radio" onclick="Evaluar_Asignar(4)" />
                        </td>
                        <td align="left">
                            <label id="Label4" style="color: navy;" onclick="Evaluar_Asignar(40)">
                                Distribución Vigente
                            </label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <input id="ch_5" type="checkbox" onclick="Evaluar_Asignar(5)" />
                        </td>
                        <td>
                            <table cellpadding="0" border="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <label id="Label5" style="color: navy" onclick="Evaluar_Asignar(5)">
                                            Aplicar aumento
                                        </label>
                                    </td>
                                    <td>
                    ...
                    <tr id="filaCantidad">
                        ...
                        <td>
                            <input id="txt_AumentarCantidad" type="text" style="width: 30px; text-align: right"
                                maxlength="4" />
                        </td>
                    </tr>
    ...
    <div id="dvEditTipoDistribucion" style="display: none; padding: 0px; margin: 0px;">
        <table style="margin: 10px;">
            ...
            <tr style="height: 30px;">
                ...
                <td>
                    <asp:DropDownList ID="ddlEditTipoDist" runat="server" Width="130">
                    </asp:DropDownList>
                </td>
            </tr>
        </table>
    ...
    <div id="dvAsignaConfigBolsa" style="display: none; padding.0px;">
        <iframe id="ifAsignaConfigBolsa" width="680px" height="430px" frameborder="0" style="padding: 0px;
            margin: 0px;"></iframe>
