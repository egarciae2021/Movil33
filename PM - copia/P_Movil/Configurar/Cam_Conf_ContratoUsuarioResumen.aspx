<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Cam_Conf_ContratoUsuarioResumen.aspx.vb" Inherits="Cam_Conf_ContratoUsuarioResumen" %>
...
<head runat="server">
    ...
    <script src="Cam_Conf_ContratoUsuarioResumen.js" type="text/javascript"></script>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="dvContenido" style="overflow: auto;">
                        ...
                        <td>
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="lblRutaContratoResumen" runat="server" Font-Bold="true"></asp:Label>
                                        &nbsp;
            ...
            <div>
                <iframe id="ifContratoResumen" frameborder="0" style="padding: 0px; margin: 0px; height: 500px; width:100%;"></iframe>
