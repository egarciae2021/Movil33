...
$(function () {
    ...
    $("#ddlPeriodo").change(function () {
        ...
        window.location.href = 'DashBoard_Consumo.aspx?pe=' + $("#ddlPeriodo").val() + '&Ope= ' + $("#ddlOperador").val() + '&TipLin=' + $("#ddlTipoLinea").val() + '&Pag = ' + TipOpc;
        window.parent.fnCerrarCargaInicial();
    });
...
function dibujarHistorico(TipServ) {
    ...
    $.ajax({
        type: "POST",
        //url: "DashBoard_Consumo.aspx/obtenerHistoricoDash",
        url: "DashBoard_Consumo.aspx/obtenerHistoricoDash_Movil",
...
function MostrarHistorico(result) {
    ...
    if (re.dataset.length > 0) {
        ...
        JSON_chart.chart.caption = "";
        JSON_chart.chart.subcaption = "";
        ...
        $("#pnlDdlHistorico").show(500, function () {
            ...
            //}
            myChartHist1 = new FusionCharts("MSCombi2D", "chartHistorico" + contador.toString(), "95%", "227", "0");
        ...
        $("#ctndCharHis *").remove();
        $("#ctndCharHis").append('<div style="font-size:medium; color:Gray; width: ' + FCWidth_ND + '; height: ' + FCHeight_ND + ';">No hay datos para mostrar.</div> ');
    }
    try {
        window.parent.fnCerrarCargaInicial();
    }
...
function MostrarHistoricoMensajes(result) {
    ...
    if (re.dataset.length > 0) {
        $("#pnlDdlHistoricoMensajes").show(500, function () {
            ...
            //}
            myChartHist2 = new FusionCharts("MSCombi2D", "chartHistoricoMensaje" + contador.toString(), "95%", "227", "0");
        ...
        $("#ctndCharHisMensajes").append('<div style="font-size:medium; color:Gray; width: ' + FCWidth_ND + '; height: ' + FCHeight_ND + ';">No hay datos para mostrar.</div> ');
    }
    try {
        window.parent.fnCerrarCargaInicial();
    }
...
function MostrarHistoricoTotal(result) {
    ...
    if (re.dataset.length > 0) {
        $("#pnlDdlHistoricoTotal").show(500, function () {
            ...
            //}
            myChartHist3 = new FusionCharts("MSCombi2D", "chartHistoricoTotal" + contador.toString(), "95%", "227", "0");
        ...
        $("#ctndCharHisTotal").append('<div style="font-size:medium; color:Gray; width: ' + FCWidth_ND + '; height: ' + FCHeight_ND + ';">No hay datos para mostrar.</div> ');
    }
    try {
        window.parent.fnCerrarCargaInicial();
    }
...
function MostrarHistoricoNavegacion(result) {
    ...
    if (re.dataset.length > 0) {
        $("#pnlDdlHistoricoNavegacion").show(500, function () {
            ...
            myChartHist4 = new FusionCharts("MSCombi2D", "chartHistoricoNavegacion" + contador.toString(), "95%", "227", "0");
        ...
        $("#ctndCharHisNavegacion").append('<div style="font-size:medium; color:Gray; width: ' + FCWidth_ND + '; height: ' + FCHeight_ND + ';">No hay datos para mostrar.</div> ');
    }
    try {
        window.parent.fnCerrarCargaInicial();
    }
...
function dibujarTopTenArea(TipServ) {
    ...
    $.ajax({
        type: "POST",
        url: "DashBoard_Consumo.aspx/obtenerSumarioDashboardTopTenJS",
...
function MostrarTopTenArea(resul) {
    if (resul[0] == "1") {
        $("#ctndCharTA *").remove();
        $("#ctndCharTA").append('<div style="font-size:medium; color:Gray; width: ' + FCWidth_ND + '; height: ' + FCHeight_ND + ';">No hay datos para mostrar.</div> ');
        //$("#dvNivelLlam").hide();
    }
    else {
...
function MostrarTopTenAreaNavegacion(resul) {
    if (resul[0] == "1") {
        ...
        $("#ctndCharTANavegacion").append('<div style="font-size:medium; color:Gray; width: ' + FCWidth_ND + '; height: ' + FCHeight_ND + ';">No hay datos para mostrar.</div> ');
        //$("#dvNivelNav").hide();
    }
    else {
        var datosChart = resul[2];
...
function MostrarTopTenAreaMensajes(resul) {
    if (resul[0] == "1") {
        ...
        $("#ctndCharTAMensajes").append('<div style="font-size:medium; color:Gray; width: ' + FCWidth_ND + '; height: ' + FCHeight_ND + ';">No hay datos para mostrar.</div> ');
        //$("#dvNivelSMS").hide();
    }
    else {
        var datosChart = resul[2];
...
function MostrarTopTenAreaTotal(resul) {
    if (resul[0] == "1") {
        ...
        $("#ctndCharTATotal").append('<div style="font-size:medium; color:Gray; width: ' + FCWidth_ND + '; height: ' + FCHeight_ND + ';">No hay datos para mostrar.</div> ');
        $("#dvNivelTotal").hide();
    }
...
function MostrarTopTenEmpleado(resul) {
    if (resul[0] == "1") {
        $("#ctndCharTE *").remove();
        $("#ctndCharTE").append('<div style="font-size:medium; color:Gray; width: ' + FCWidth_ND + '; height: ' + FCHeight_ND + ';">No hay datos para mostrar.</div> ');
...
function MostrarTopTenEmpleadoNavegacion(resul) {
    if (resul[0] == "1") {
        ...
        $("#ctndCharTENavegacion").append('<div style="font-size:medium; color:Gray; width: ' + FCWidth_ND + '; height: ' + FCHeight_ND + ';">No hay datos para mostrar.</div> ');
...
function MostrarTopTenEmpleadoMensajes(resul) {
    if (resul[0] == "1") {
        ...
        $("#ctndCharTEMensajes").append('<div style="font-size:medium; color:Gray; width: ' + FCWidth_ND + '; height: ' + FCHeight_ND + ';">No hay datos para mostrar.</div> ');
        $("#dvSMSEmpleados").hide();
    }
    else {
        var datosChart = resul[2];
...
function MostrarTopTenEmpleadoTotal(resul) {
    ...
    if (resul[0] == "1") {
        ...
        $("#ctndCharTETotal").append('<div style="font-size:medium; color:Gray; width: ' + FCWidth_ND + '; height: ' + FCHeight_ND + ';">No hay datos para mostrar.</div> ');
...
function dibujarPie() {
    ...
    $.ajax({
        type: "POST",
        url: "DashBoard_Consumo.aspx/obtenerPieDash",
...
function MostrarPie(resul) {
    if (resul[0] == "1") {
        ...
        $("#ctndCharPie *").remove();
        $("#ctndGrilla").empty();
        $("#ctndCharPie").append('<div style="font-size:medium; color:Gray; width: ' + FCWidth_ND + '; height: ' + FCHeight_ND + ';">No hay datos para mostrar.</div> ');
        $("#ctndGrilla").append('<div style="font-size:medium; color:Gray; width: '+ FCWidth_ND +'; height: '+ FCHeight_ND +';">No hay datos para mostrar.</div> ');
    }
    else {
        ...
        JSON_chart.chart.showlabels = "1";
        JSON_chart.chart.labelFontBold = "1";
        ...
        if (!(FusionCharts("myChartIdPie"))) {
            ...
            var myChart4 = new FusionCharts("doughnut2d", "myChartIdPie", "100%", "250", "0");
        }
...
function fnAgregarTapsTipoServicio() {
    ...
    if (misTiposServicios.length > 0) {
        ...
        var AnchoTotal = $(window).width(); //$("#prueba").width();
        var AnchoUnidad = (AnchoTotal / (misTiposServicios.length + 1)) - 15;
        var i = 0;
...
function fnObtenerCuerpoTapGenerico(ID) {
    var cadena = "";
    cadena = cadena + "<div id='DvPnl_" + ID + "' class='AnchoTotal'>";
    cadena = cadena + "<div class='col-xs-12 col-sm-12'>";
    cadena = cadena + "<div class='panel'>";
    cadena = cadena + "<div class='panel-body form-horizontal form-padding' style='padding-bottom: 0px;'>";
    cadena = cadena + "<div id='pnlHistorico_" + ID + "'>";
    cadena = cadena + "<div id='ctndCharHis_" + ID + "'></div>";
    cadena = cadena + "<div id='pnlDdlHistorico_" + ID + "' class='form-group'>";
    cadena = cadena + "<label class='col-sm-3 col-lg-2 control-label' for='demo-hor-inputemail'>Tipo </label>";
    cadena = cadena + "<div class='col-sm-9 col-lg-4'>";
    cadena = cadena + "<select id='selectTipo_" + ID + "' style='width: 100%;'>";
    cadena = cadena + "<option value='Costo' selected='selected'>Costo</option>";
    cadena = cadena + "<option value='Llamadas'>Cantidad</option>";
    cadena = cadena + "</select>";
    cadena = cadena + "</div>";
    cadena = cadena + "<label class='col-sm-3 col-lg-2 control-label' for='demo-hor-inputemail'>Meses Atras </label>";
    cadena = cadena + "<div class='col-sm-9 col-lg-4'>";
    cadena = cadena + "<select id='ddlMesesAtras_" + ID + "' style='width: 100%;'>";
    ...
    cadena = cadena + "<div class='col-xs-12 col-sm-6 col-md-6'>";
    cadena = cadena + "<div class='panel'>";
    cadena = cadena + "<div class='panel-body form-horizontal form-padding' style='padding-bottom: 0px;'>";
    cadena = cadena + "<div id='ctndCharTA_" + ID + "'></div>";
    cadena = cadena + "<div id='dvNivel_" + ID + "' class='form-group'>";
    cadena = cadena + "<label class='col-sm-3 control-label' for='demo-hor-inputemail'>Nivel: </label>";
    cadena = cadena + "<div class='col-sm-9'>";
    cadena = cadena + "<select id='ddlNivel_" + ID + "' style='width: 100%;'>";
    cadena = cadena + "</select>";
    cadena = cadena + "</div>";
    cadena = cadena + "</div>";
    cadena = cadena + "</div>";
...
function MostrarHistoricoDinamico(result) {
    ...
    if (re.dataset.length > 0) {
        ...
        //}
        myChartHist5 = new FusionCharts("MSCombi2D", "chartHistorico_" + IdDinamico + contador.toString(), "95%", "227", "0");
        ...
        $("#ctndCharHis_" + IdDinamico).append('<div style="font-size:medium; color:Gray; width: ' + FCWidth_ND + '; height: ' + FCHeight_ND + ';">No hay datos para mostrar.</div> ');
    }
    try {
        window.parent.fnCerrarCargaInicial();
    }
...
function MostrarTopTenAreaDinamico(resul) {
    if (resul[0] == "1") {
        ...
        $("#ctndCharTA_" + IdDinamico).append('<div style="font-size:medium; color:Gray; width: ' + FCWidth_ND + '; height: ' + FCHeight_ND + ';">No hay datos para mostrar.</div> ');
        if (!EventoClickNivel) {
...
function MostrarTopTenEmpleadoDinamico(resul) {
    if (resul[0] == "1") {
        ...
        $("#ctndCharTE_" + IdDinamico).append('<div style="font-size:medium; color:Gray; width: ' + FCWidth_ND + '; height: ' + FCHeight_ND + ';">No hay datos para mostrar.</div> ');
        //$("#dvLlamadasEmple").hide();
    }
    else {
        var datosChart = resul[2];
