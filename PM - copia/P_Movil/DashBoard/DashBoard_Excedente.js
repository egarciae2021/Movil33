    ...
    $("#dwDesde").change(function () {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                window.location.href = 'DashBoard_Excedente.aspx?pe=' + $("#dwDesde").val();
...
function Listar_GrupoServicio(_ContenidoConcepto) {
    ...
    const data  = {
        p_vcMesInicial: vcMesInicial,
        p_vcMesFin: vcMesFin,
        p_idOperador: idOperador,
        p_idExpresado: idExpresado,
        p_inTipLin: p_inTipLin,
        p_vcCodCuenta: p_vcCodCuenta,
        codAreaSeleccionada: codAreaSeleccionada
    }

    //debugger;
    $.ajax({
        type: "POST",
        url: "DashBoard_Excedente.aspx/Listar_GrupoServicio",
        ...
        success: function (result) {
            ...
            $("#lblMontoTotal").html("");
            $("#lblPorcentajeTotalExceso").html("");
            $("#lblEmpresaMayorExceso").html("");
            // ==============================================================================================================================
            if ($(result.d).length > 0) {
               
                const { total, monto, excedente, empresa, porcentaje } = result.d;
                $("#lblMontoTotal").html(oCulturaUsuario.Moneda.vcSimMon + excedente);
                $("#lblPorcentajeTotalExceso").html(porcentaje.split(SimDec)[0]);
                $("#lblEmpresaMayorExceso").html(empresa);
...
function Grafico_Historico_Periodo(inParam, inShowValues, inModo) {
    ...
    $.ajax({
        // ==============================================================================================================================
        type: "POST",
        url: "DashBoard_Excedente.aspx/Grafico_Historico_Periodo",
        ...
        success: function (result) {
            ...
            if ($(result.d).length > 0) {
                ...
                var cadena3 = '{"chart": {"baseFont":"Open Sans", "baseFontColor": "#6b737c", "caption": "HISTÓRICO DE EXCESO", "subCaption": "(Últimos 06 meses)","xaxisname": "","pyaxisname": "Costo", "syaxisname": "Porcentaje", "snumberSuffix": "%", "legendBorderThickness": "0","legendShadow":"0","exportFileName":"HistoricoFacturacion",';
                ...
                var i = 0;
                for (i = 0; i < $(result.d).length; i++) {
                    item3 = '{"label": "' + result.d[i].MesAnio + '"}';
                ...
                for (i = 0; i < $(result.d).length; i++) {
                    //debugger
                    var item3 = '{"value": "' + result.d[i].NuValorExcedente + '","alpha": "100", "color" : "' + vcColor + '" }';
                    if (i + 1 != $(result.d).length) {
                        item3 = item3 + ',';
                    }
                    cadena3 = cadena3 + item3;
                ...
                cadena3 = cadena3 + ']} ,{"seriesname": "Porcentaje", "showvalues": "0", "color":"#747F81","parentYAxis": "S", "renderas": "Line", "data": [ ';
                for (i = 0; i < $(result.d).length; i++) {
                    item3 = '{"value": "' + result.d[i].Porcentaje + '","label":"x", "numberPrefix": "%" }';
                    if (i + 1 != $(result.d).length) {
                        item3 = item3 + ',';
                    }
                    cadena3 = cadena3 + item3;
                ...
                if (inModo == 1) {
                    ...
                    console.log(JSON.parse(JsonHistoricoPeriodo));
...
function Grafico_TopTen_Costo_() {
    ...
    $.ajax({
        // ==============================================================================================================================
        type: "POST",
        url: "DashBoard_Excedente.aspx/Grafico_TopTen_Costo",
        ...
        success: function (result) {
            ...
            if ($(result.d).length > 0) {
                ...
                if (TipoTopTenCosto == "Empleado") {
                    cadena = cadena + '"subCaption": "(Costo excedido agrupados por Empleados)",';
                }
                else {
                    cadena = cadena + '"subCaption": "(Costo excedido agrupados por Líneas)",';
                }

                cadena = cadena + '"showYAxisValues": "1","showvalues": "0","seriesnameintooltip": "1","showlegend": "0","caption": "TOP TEN DE EXCESO","xAxisName": "","yAxisName": "","numberPrefix": "' + oCulturaUsuario.Moneda.vcSimMon + '",';
                ...
                var i = 0;
                for (i = 0; i < $(result.d).length; i++) {
                    var item = '{"label": "' + result.d[i].TipoAgrupado + '" }';
                    if (i + 1 != $(result.d).length) {
                        item = item + ',';
                    }
                    cadena = cadena + item;
                ...
                for (i = 0; i < $(result.d).length; i++) {
                    ...
                    item = '{"value": "' + result.d[i].Excedente + '", "label":"' + result.d[i].TipoAgrupado + '","color": "' + itemColor + '",';
                    if (TipoTopTenCosto != "Empleado") {
                        //item = item + '"link":"j-clickChart-' + result.d[i].TipoAgrupado + '",';
                    }
                    item = item + '"alpha":"100",';
                    item = item + '"tooltext":"Línea: ' + result.d[i].TipoAgrupado + ', Exceso: ' + oCulturaUsuario.Moneda.vcSimMon + FormatoNumero(result.d[i].Excedente, oCulturaUsuario, false) + '" }';
                    if (i + 1 != $(result.d).length) {
                        item = item + ',';
                    }
                    cadena = cadena + item;
...
function Grafico_TopTen_Servicio_() {
    ...
    $.ajax({
        // ==============================================================================================================================
        type: "POST",
        url: "DashBoard_Excedente.aspx/Grafico_TopTen_Servicio",
        data: "{'p_vcMesInicial':'" + vcMesInicial + "','p_idGrupo':'" + idGrupo + "','TipoTopTenCosto':'" + TipoTopTenCosto + "','p_idOperador':'" + idOperador +
            "', 'p_inTipLin': '" + idTipLin + "', 'p_vcCodCue': '" + vcCodCue + "','Nivel':'" + Nivel + "'}",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (result) {
            ...
            if ($(result.d).length > 0) {
                ...
                cadena = cadena + '"subCaption": "(Costo excedido agrupados por Plan)",';
                

                cadena = cadena + '"showYAxisValues": "1","showvalues": "0","seriesnameintooltip": "1","showlegend": "0","caption": "TOP TEN DE PLANES CON EXCESO","xAxisName": "","yAxisName": "","numberPrefix": "' + oCulturaUsuario.Moneda.vcSimMon + '",';
                cadena = cadena + '"bgColor": "#ffffff", "showBorder": "0", "showCanvasBorder": "0", "usePlotGradientColor": "0", "plotBorderAlpha": "25","theme": "fusion", "exportenabled" : "1","exportShowMenuItem":"1",';
                cadena = cadena + '"placeValuesInside": "1", "showAxisLines": "1", "xAxisLineColor": "#999999", "yAxisLineColor": "#FFFFFF", "axisLineAlpha": "10","divLineIsDashed": "1",';
                cadena = cadena + '"divLineAlpha": "30", "showAlternateVGridColor": "0", "captionFontSize": "16", "subcaptionFontSize": "12", "subcaptionFontBold": "0","numberscalevalue": "100,100,100",';
                cadena = cadena + '"formatNumberScale": "0", "formatNumber": "1", "forceDecimals": "1", "sdecimals": "0", "decimals": "0",';
                ...
                var i = 0;
                for (i = 0; i < $(result.d).length; i++) {
                    var item = '{"label": "' + result.d[i].Plan + '" }';
                    if (i + 1 != $(result.d).length) {
                        item = item + ',';
                    }
                    cadena = cadena + item;
                ...
                for (i = 0; i < $(result.d).length; i++) {
                    var itemColor = vcColor;
                    item = '{"value": "' + result.d[i].Exceso + '", "label":"' + result.d[i].Plan + '","color": "' + itemColor + '",';
                    if (TipoTopTenCosto != "Servicio") {
                        // item = item + '"link":"j-clickChart-' + result.d[i].Plan + '",';
                    }
                    item = item + '"alpha":"100",';
                    item = item + '"tooltext":"Plan: ' + result.d[i].Plan + ', Exceso: ' + oCulturaUsuario.Moneda.vcSimMon + FormatoNumero(result.d[i].Exceso, oCulturaUsuario, false) + '" }';
                    if (i + 1 != $(result.d).length) {
                        item = item + ',';
                    }
                    cadena = cadena + item;
...
function Grafico_Inferior_(inParam, inShowValues, inModo) {
    ...
    $.ajax({
        // ==============================================================================================================================
        type: "POST",
        url: "DashBoard_Excedente.aspx/Grafico_Inferior",
        ...
        success: function (result) {
            ...
            if ($(result.d).length > 0) {
                ...
                cadena2 = cadena2 + '"caption":"DISTRIBUCIÓN DE EXCESO POR CONCEPTO","subCaption":"(Según montos excedidos)", "subCaptionFontColor":"#9E9C9C","exportFileName":"DistribucionPorConceptos", ';
                ...
                for (i = 0; i < $(result.d).length; i++) {
                    ...
                    var item = '{"label": "' + vcMesInicial.substring(0, 3) + '","color": "' + vcColor + '","value": "' + result.d[i].Valor + '"}';
                    var item2 = '{"label": "' + vcMesInicial.substring(0, 3) + '","color": "' + vcColor + '","value": "' + result.d[i].Valor + '"}';
                    item2 = '{"label": "' + result.d[i].NombreAbreviado + '","alpha": "100","color": "' + vcColor + '","value": "' + result.d[i].Valor + ' ", "issliced" : "0" }';
                    if (i + 1 != $(result.d).length) {
                        item = item + ',';
                        item2 = item2 + ',';
                    }
...
function ListarCuentaPlanesPorOperador() {
    ...
    if ($("#dwOperador").val() == -1) {
        $('#dwOperador option:selected').next().attr('selected', 'selected');
    }
