<%@ Page Language="VB" AutoEventWireup="false" Inherits="P_Movil_Facturacion_Configuracion_Fac_Conf_CuentaCobro"
    CodeBehind="Fac_Conf_CuentaCobro.aspx.vb" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Configuración de Cuenta de Cobro</title>
...
<body>
    <script src="<%=UtilitarioWeb.ObtieneVersionArchivoEstatico("Fac_Conf_CuentaCobro.js")%>" type="text/javascript"></script>
        ...
        <table id="tbConfVeri" border="0" width="100%">
            <tbody>
                <tr>
                    ...
                    <td>
                        <div id="dvEjecTarea" style="text-align: right;" runat="server">
