...
Partial Class Con_Fac_ReportesDev
        ...
        Try
            ...
            Else
                If Not IsPostBack Then
                    ...
                    ''End If
                    ''ddlReportes.Items.Add(New ListItem("--Seleccione--", "-1"))
                    ''ddlReportes.Items.Add(New ListItem("--Seleccione--", "-1"))
                    ''ddlReportes.Items.Add(New ListItem("--Seleccione--", "-1"))
                    ''ddlReportes.Items.Add(New ListItem("--Seleccione--", "-1"))
                    ...
                    Dim dtParamConf As DataTable, strValConf As String
                    dtParamConf = ServicioGeneral.ListarParametrosXClave("MostrarConsumoFacturacion", "CONSFAC")

                    hdfMostrarOpcConsumo.Value = "1"
                    If Not (dtParamConf Is Nothing) Then
                        If (dtParamConf.Rows.Count > 0) Then
                            strValConf = dtParamConf.Rows(0)("Valor").ToString()
                            hdfMostrarOpcConsumo.Value = strValConf
                        End If
                    End If
