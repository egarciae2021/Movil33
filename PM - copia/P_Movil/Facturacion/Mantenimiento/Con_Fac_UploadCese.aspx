<%@ Page Language="VB" AutoEventWireup="false" Inherits="P_Movil_Facturacion_Mantenimiento_Con_Fac_Cese"
    CodeBehind="Con_Fac_UploadCese.aspx.vb" %>
...
<body>
    ...
    <div id="dvContenido" style="overflow: auto;">
        ...
        <iframe id="ifCargarImagen" frameborder="0" style="padding: 0px; margin: 0px; height: 33px;
            width: 482px;" src="../../../Common/Page/Adm_CargarArchivo.aspx?Formatos=txt,csv,xls,xlsx&FormatoTipo=">
        </iframe>
        <%--        <iframe id="ifCargarImagen" frameborder="0" style="padding: 0px; margin: 0px; height: 33px;
