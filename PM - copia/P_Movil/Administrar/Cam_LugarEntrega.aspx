<%@ Page Language="VB" AutoEventWireup="false" Inherits="P_Movil_Administrar_Cam_LugarEntrega" Codebehind="Cam_LugarEntrega.aspx.vb" %>
...
<head runat="server">
    ...
    <script src="Cam_LugarEntrega.js" type="text/javascript"></script>
    ...
    <form id="form1" runat="server">
                ...
                <tr>
                    ...
                    <td rowspan="2" valign="middle" style="width:200px">
                        ...
                        <asp:DropDownList ID="ddlBusqueda" runat="server" style="margin-left:15px; font-weight:normal;" Width="150px">
                            <asp:ListItem Value="vcEnt">Descripción</asp:ListItem>
                            <asp:ListItem Value="vcDes">Dirección</asp:ListItem>
                        </asp:DropDownList>
                    </td>
        ...
        <div class="ui-widget-content ui-corner-all" style="padding:0px; margin:0px; background-image:none;">            
            <table border="0">
                <tr>
                    <td style="width:60px">
                        <asp:Label ID="Label1" runat="server" Text="Importar" CssClass="lblToolBAR"></asp:Label>
                    </td>
                    <td rowspan="2" valign="middle" style="width:200px">
        ...
        <div id="dvProducto" style="display:none;">
            <iframe id="ifProducto" frameborder="0" style="padding: 0px; margin: 0px; height: 465px; width:630px;"></iframe>
        </div>
    </form>
</body>
</html>