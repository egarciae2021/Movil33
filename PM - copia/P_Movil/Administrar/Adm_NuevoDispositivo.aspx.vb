...
Partial Class P_Movil_Administrar_Adm_NuevoDispositivo
    ...
    <WebMethod()>
    Public Shared Function VerificaLineaEmpleado(ByVal vcCodEmp As String) As String
        Try
    ...
    <WebMethod()>
    Public Shared Function EnviaSolicitud(ByVal inCodModDis As String, ByVal vcCodEmp As String, ByVal vcArchAdj As String) As String
        Try
            Dim resultado As Integer
            Dim oUsuario As ENT_SEG_Usuario = CType(HttpContext.Current.Session("Usuario"), ENT_SEG_Usuario)
            ...
            'resultado = Solicitud.Insertar(oLinea, Convert.ToInt32(UtilitarioWeb.TipoSolicitud.Nuevo), oUsuario)
            If resultado <> 0 Then
                ...
                '    String.Format(cuerpo, oEmpleado.vcNom, "Nuevo dispositivo")
