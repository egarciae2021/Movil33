<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Imp_RegistroServicio.aspx.vb" Inherits="P_Movil_Administrar_Imp_RegistroServicio" %>
<%--Inherits=".Imp_RegistroServicio" --%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <script src="<%=UtilitarioWeb.ObtieneVersionArchivoEstatico("Imp_RegistroServicio.js")%>" type="text/javascript"></script>
        <form id="form1" runat="server">
            ...
            <cc1:TabJQ runat="server" ID="TabOpciones" CssClass="tabs" Style="margin-top: 1px;">
                <cc1:ContenedorTabJQ Titulo="Servicios" CssClass="tabHijo" Height="310px">
                    <table>
                        <tr>
                            <td>
                                <h3><asp:Label runat="server" ID="lblSinReg" Text="Servicios"></asp:Label>  sin registrar</h3>
                                <asp:TextBox ID="txtFiltroServicio" runat="server" ToolTip="Ingrese un valor para filtrar Servicios" style="width: 230px;"></asp:TextBox>
                                <div id="dvServicio" class="ui-tabs-panel ui-widget-content ui-corner-all" style="padding:10px; margin-top:10px; width:280px; height: 200px; overflow:auto; text-align:left;" >                        
                                    <asp:CheckBoxList ID="chklstServiciosSinRegistrar" runat="server" Width="270px"></asp:CheckBoxList>
                                </div>                            
                            </td>
                ...
                <cc1:ContenedorTabJQ Titulo="Servicio" CssClass="tabHijo" Height="310px">                
                    <table>
                        <tr>
                            <td>
                                <h3><asp:Label runat="server" ID="lblAregistrar" Text="Servicios"></asp:Label> a registrar</h3>
                                <asp:ListBox ID="lstServicio" runat="server" Width="230px" Height="250px" ></asp:ListBox>
                            </td>
                            <td>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td style="text-align:right;">
                                                <div id="btnGuardar" class="btnNormal" style="width:100px;">
