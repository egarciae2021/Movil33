<%@ Page Language="VB" AutoEventWireup="false" Inherits="P_Movil_Administrar_Adm_ReposicionDispositivo" Codebehind="Adm_ReposicionDispositivo.aspx.vb" %>
...
<head id="Head1" runat="server">
    ...
    <script src="Adm_ReposicionDispositivo.js" type="text/javascript"></script>
</head>
<body>
    ...
    <asp:HiddenField ID="hdfListaUbi" runat="server" /> <%--agregado 05-09-2013--%>
    ...
    <div id="divEnvio" runat="server">
        <table>
            <tr>
                <td>
                    Enviar solicitud de reposición de equipo con el equipo visualizado
                </td>
                <td>
                    ...
                    <div id="btnRetroceder" class="btnNormal">
                        <asp:Image ID="imgRetroceder" runat="server" ImageUrl="~/Common/Images/Mantenimiento/Regresar.png"/>
                        <a>Regresar</a>
                    </div>
                </td>
            </tr>
