...
Partial Class P_Movil_Administrar_Imp_Proceso_52
        ...
        Try
            ...
            Else
                ...
                If Not IsPostBack Then
                    ...
                    ddlExtensionArchivo.SelectedValue = 3
                    ...
                    End If
                    ddlTipoPlantilla.SelectedValue = 2
    ...
    Protected Sub btnGuardar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnGuardarSer.Click
        ...
        Try
            ...
            Dim passwords As String() = hdfPassword.Value.Substring(1, hdfPassword.Value.Length - 1).Split(",")
