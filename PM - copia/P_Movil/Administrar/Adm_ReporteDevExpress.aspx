    ...
    <form id="form1" runat="server">
        ...
        <div id="dvReporte" runat="server" align="center">
            ...
            <dx:ReportViewer ID="dxReportViewer" runat="server"
                ...
                SpriteCssFilePath="~/App_Themes/Office2003Blue/{0}/sprite.css" Theme="Office2010Silver" Report="<%# new XRPT_Linea_Reporte_Historicos() %>" ReportName="XRPT_Linea_Reporte_Historicos">
