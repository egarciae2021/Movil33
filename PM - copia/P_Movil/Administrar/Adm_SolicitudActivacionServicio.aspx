<%@ Page Language="VB" AutoEventWireup="false" Inherits="P_Movil_Administrar_Adm_SolicitudActivacionServicio" Codebehind="Adm_SolicitudActivacionServicio.aspx.vb" %>
...
<head runat="server">
    ...
    <script src="Adm_SolicitudActivacionServicio.js" type="text/javascript"></script>
</head>
<body>
    <form id="form1" runat="server">
        ...
        <asp:HiddenField ID="hdfCodCuenta2" runat="server" />
        <asp:HiddenField ID="hdfAdmin" runat="server" />
        <div id="dvContenido" class="dvPanel">
            <div>
                <asp:Label ID="lblTituloSolicitud" runat="server" Text="Activación de Servicio"></asp:Label>
            </div>
            <table><tr><td>
            <table>
                <tr>
