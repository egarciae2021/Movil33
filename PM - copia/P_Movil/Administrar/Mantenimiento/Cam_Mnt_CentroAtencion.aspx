<%@ Page Language="VB" AutoEventWireup="false" Inherits="P_Movil_Administrar_Mantenimiento_Cam_Mnt_CentroAtencion" Codebehind="Cam_Mnt_CentroAtencion.aspx.vb" %>
...
<head runat="server">
    ...
    <script src="Cam_Mnt_CentroAtencion.js" type="text/javascript"></script>
    <%--<script type="text/javascript"></script>--%>
</head>
<body>
    <form id="form1" runat="server">
        <asp:HiddenField ID="hdfIdCentroAtencion" runat="server"/>
        ...
        <div id="dvContenido">
            <div id="dvCampos">
                <table>
                    ...
                    <tr>
                        <td class="tdEtiqueta">
                            <asp:Label ID="lblRegionCab" runat="server" Text="Región"></asp:Label>                        
                        </td>
                        <td class="">
                    ...
                    <tr>
                        <td class="tdEtiqueta">
                            <asp:Label ID="txtDireccionCab" runat="server" text="Dirección"></asp:Label>
                        </td>
                        <td>
