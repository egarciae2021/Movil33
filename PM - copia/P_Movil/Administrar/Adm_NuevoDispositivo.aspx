<%@ Page Language="VB" AutoEventWireup="false" Inherits="P_Movil_Administrar_Adm_NuevoDispositivo" Codebehind="Adm_NuevoDispositivo.aspx.vb" %>
...
<head id="Head1" runat="server">
    ...
    <script src="Adm_NuevoDispositivo.js" type="text/javascript"></script>
</head>
<body>
    ...
    <div id="divEnvio" runat="server">
        <table>
            <tr>
                <td>
                    Enviar solicitud de nuevo de equipo con el equipo visualizado
                </td>
                <td>
