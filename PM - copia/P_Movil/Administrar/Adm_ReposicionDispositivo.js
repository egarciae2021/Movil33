...
$(function () {
    ...
    var Modal = $("#divSeguridad").dialog({
        title: 'Seguridad (Reposición de equipo)',
        height: 160,
        width: 480,
        modal: true,
        resizable: false,
            ...
            if ($("#txtNumero").val() != "") {
                $.ajax({
                    ...
                    success: function (result) {
                        if (result.d == "1") {
                            $("#lblMensaje").html("La linea no pertenece al usuario indicado");
                        }
                        else if (result.d == "2") {
                            $("#lblMensaje").html("Ya existe una solicitud para esta linea");
                        }
                        else {//
                            //Modal.dialog('close');
                            window.location = "Adm_ReposicionDispositivo.aspx?vcCodEmp=" + CodEmp + "&dcNumLin=" + numero;
                        }
                    },
