...
Public Class Adm_Rpt_DespachoCargo
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Adm_Rpt_DespachoCargo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAdm_Rpt_DespachoCargo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Adm_Rpt_DespachoCargo = New Adm_Rpt_DespachoCargo()
        rpt.Site = Me.Site
        Return rpt
    End Function
