...
Public Class Cam_Rpt_PedidoDetalle
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Cam_Rpt_PedidoDetalle.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCam_Rpt_PedidoDetalle
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cam_Rpt_PedidoDetalle = New Cam_Rpt_PedidoDetalle()
        rpt.Site = Me.Site
        Return rpt
    End Function
