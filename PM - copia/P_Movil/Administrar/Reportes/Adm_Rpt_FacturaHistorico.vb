...
Public Class Adm_Rpt_FacturaHistorico
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Adm_Rpt_FacturaHistorico.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAdm_Rpt_FacturaHistorico
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Adm_Rpt_FacturaHistorico = New Adm_Rpt_FacturaHistorico()
        rpt.Site = Me.Site
        Return rpt
    End Function
