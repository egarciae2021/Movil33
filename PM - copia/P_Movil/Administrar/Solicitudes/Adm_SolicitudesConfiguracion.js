...
var mydata = [{ Idd: "in0_daFechaCreacion", Campo: "daFechaCreacion", Descripcion: "Fecha Creación", IdTipoDato: "5", TipoDato: "Fecha - Hora", Tamano: "", ValidaTexto: "", ValidaNumero: "", PermiteAdicionar: "", Activo: "True" },
    { Idd: "in0_daFechaModificacion", Campo: "daFechaModificacion", Descripcion: "Fecha Modificación", IdTipoDato: "5", TipoDato: "Fecha - Hora", Tamano: "", ValidaTexto: "", ValidaNumero: "", PermiteAdicionar: "", Activo: "True" },
    //                    { Idd: "in0_F_inFasSol", Campo: "F_inFasSol", Descripcion: "Fase", IdTipoDato: "1", TipoDato: "Numérico Entero", Tamano: "" },
    { Idd: "in0_F_vcCodEmp", Campo: "F_vcCodEmp", Descripcion: "Empleado", IdTipoDato: "3", TipoDato: "Texto", Tamano: "75", ValidaTexto: "", ValidaNumero: "", PermiteAdicionar: "", Activo: "True" }, //cambio de tamaño de campo empleado de 15 a 75
    { Idd: "in0_inUsuarioCreacion", Campo: "inUsuarioCreacion", Descripcion: "Usuario Creación", IdTipoDato: "1", TipoDato: "Numérico Entero", Tamano: "", ValidaTexto: "", ValidaNumero: "", PermiteAdicionar: "", Activo: "True" },
    { Idd: "in0_inUsuarioModificacion", Campo: "inUsuarioModificacion", Descripcion: "Usuario Modificación", IdTipoDato: "1", TipoDato: "Numérico Entero", Tamano: "", ValidaTexto: "", ValidaNumero: "", PermiteAdicionar: "", Activo: "True" }
    , { Idd: 'in0_vcCodigo', Campo: 'vcCodigo', Descripcion: 'Código', IdTipoDato: "3", TipoDato: "Texto", Tamano: "15", ValidaTexto: "", ValidaNumero: "", PermiteAdicionar: "", Activo: "True" }, //agregado 08-09-2014 - wapumayta
];
...
$(function () {
        ...
        if (biExiste == 0) {
            if (textoAgregar == "Agregar") { //agregar nuevo campo
                ...
                for (i = 0; i < vcEstadoProcesos.length; i++) {
                    ...
                    arTipSol.EstadoProceso[vcEstadoProcesos[i]].Campos[vcCampo] = {
                        Campo: vcCampo,
                        Descripcion: vcDescripcion, Visible: '-1',
                        Editable: '-1', Obligatorio: '-1', IdCampo: "0"
                    };
                }
    ...
    tbCampos = $("#tbCampos").jqGrid({
        ...
        colModel: [
            ...
            { name: 'Idd', Campo: 'Idd', label: 'Idd', hidden: true, width: 150, sortable: false },
            ...
            { name: 'LongitudMin', index: 'LongitudMin', label: 'Longitud Mínima', hidden: false, width: 100, sortable: false },
            { name: 'ValidaTexto', index: 'ValidaTexto', label: 'Valida Texto', hidden: false, width: 60, sortable: false },
            { name: 'ValidaNumero', index: 'ValidaNumero', label: 'Valida Numero', hidden: false, width: 60, sortable: false },
            { name: 'PermiteAdicionar', index: 'PermiteAdicionar', label: 'Permite Adicionar', hidden: false, width: 60, sortable: false },
                    {
    ...
    tbCamposDestino = $("#tbCamposDestino").jqGrid({
        sortable: true,
        datatype: "local",
        colModel: [{ name: 'Idd', Campo: 'Idd', label: 'Idd', hidden: true, width: 150, sortable: false },
                    { name: 'Campo', Campo: 'Campo', label: 'Campo', hidden: false, width: 150, sortable: false },
                    { name: 'CampoSolicitud', Campo: 'CampoSolicitud', label: 'CampoSolicitud', hidden: true, width: 150, sortable: false },
                    { name: 'Descripcion', index: 'Descripcion', label: 'Descripción', hidden: false, width: 200, sortable: false },
                    { name: 'IdTipoDato', index: 'IdTipoDato', label: 'IdTipoDato', hidden: true, width: 150, sortable: false },
                    { name: 'TipoDato', index: 'TipoDato', label: 'Tipo de Dato', hidden: true, width: 130, sortable: false },
            { name: 'Tamano', index: 'Tamano', label: 'Tamaño', hidden: true, width: 150, sortable: false },
            { name: 'ValidaTexto', index: 'ValidaTexto', label: 'Valida Texto', hidden: false, width: 80, sortable: false },
            { name: 'ValidaNumero', index: 'ValidaNumero', label: 'Valida Numero', hidden: false, width: 80, sortable: false },
            { name: 'PermiteAdicionar', index: 'PermiteAdicionar', label: 'Permite Adicionar', hidden: false, width: 60, sortable: false },
                    {
                        name: 'IdCampo', index: 'IdCampo', label: 'IdCampo', hidden: true, width: 200, sortable: false,
                        formatter: function (value, options, rData) {
        ...
        afterInsertRow: function (rowid, aData, rowelem) {
            ...
            if (rowid == "in0_F_inFasSol" || rowid == "in0_F_vcCodEmp" || rowid == "in0_daFechaCreacion" || rowid == "in0_daFechaModificacion" || rowid == "in0_inUsuarioCreacion" ||
                ...
                var i;
                for (i in colModels) {
                    tbCamposDestino.jqGrid('setCell', rowid, i, '', { color: 'grey' });
                }
            } else {
                if (aData.Activo == 'False' || aData.Activo == 'Inactivo') {
                    var i;
                    for (i in colModels) {
                        tbCamposDestino.jqGrid('setCell', rowid, i, '', { color: '#cd0a0a' });
                    }
                }
            }
        },
    ...
    function ActualizaArrayPorEstadoAprobacion(vcNomEstAprReg, vcNomEstAprMsj) {
        ...
        //Mensajes
        if (vcNomEstAprMsj != "0") {
            var biEnvCor = "0", biPro = "0", biUsuEsp = "0", biAre = "0", biTec = "0", biTecs = "0";
    ...
    $("#btnGuardar").live("click", function () {
        ...
        if (biUsuEsp == "1") { vcResApr = $("#hdIdRespUsuario").val(); }
        ...
        if ($("#chkUmbralAprobacion").is(":checked")) {
            ...
            for (h = 0; h < vcEstApr.length; h++) {
                ...
                XMLUmbralEstado += '\" ValorMaximoDias=\"' + ValorMaximoDias + '\" Destinatarios=\"' + Destinatarios + '\" Asunto=\"' + Asunto + '\" Mensaje=\"' + MensajeUmbral + '\" IdUmbral=\"' + IdUmbral + '\" MedidaUmbral=\"' + medidaUmbral + '\" />';
            }
        }
        ...
        for (i = 0; i < vcEstadoProcesos.length; i++) {
            ...
            if (arTipSol.EstadoProceso[vcEstadoProcesos[i]].Id != 6) {
                if (arTipSol.Umbrales.Proceso[vcEstadoProcesos[i]].Umbral == "1") {
                    ...
                    XMLUmbralEstado += '<DATA IdSolicitudTipo=\"' + IdSolicitudTipo + '\" EstadoInicial=\"' + EstadoInicial + '\" EstadoFinal=\"' + EstadoFinal + '\" ValorObjetivoDias=\"' + ValorObjetivoDias;
                    XMLUmbralEstado += '\" ValorMaximoDias=\"' + ValorMaximoDias + '\" Destinatarios=\"' + Destinatarios + '\" Asunto=\"' + Asunto + '\" Mensaje=\"' + MensajeEstadoProceso + '\" IdUmbral=\"' + IdUmbral + '\" MedidaUmbral=\"' + medidaUmbral + '\" />';
                }
            }
                                                ...
                                                $("#dvConfirmacionGuardarDevolucion").dialog({
                                                    ...
                                                    buttons: {
                                                        "Continuar": function () {
                                                            ...
                                                            XMLTipoProducto, intCategoria, lstMensajeOperador, XMLCamposDestino, XMLCamposReferenciaCondicionDestino, EnviarOperador
                                                            , $("#chkUsaFinanciamiento").is(":checked"), $("#hdfTecnicoDirecto").val(),XMLMensajePorEstadoAdjunto );
                                                        },
                                                        "Volver": function () {
                                                            $(this).dialog("close");
                                                        }
    ...
    var dataParamCorDev = [{ Param: 'Propietario', Desc: 'Correo del propietario de la Solicitud.', Tipo: 'Destinatario' },
                            ...
                            { Param: 'TecAsignado', Desc: 'Correo del especialista asignado a la solicitud devuelta.', Tipo: 'Destinatario' },
                            { Param: 'TecResponsable', Desc: 'Correo del especialista responsable del tipo de solicitud.', Tipo: 'Destinatario' },
    ...
    function fnActualizarDatosEnvioOper() {
        ...
        if (oper == -1) { return; }
        if (arDatosEnvOper.length == 0) { return; }
...
XMLTipoProducto, intCategoria, lstMensajeOperador, XMLCamposDestino, XMLCamposCondicionDestino, EnviarOperador
    , usaFinanciamiento, tecnicoDirecto, XMLCamposAdjuntosPorEstadoMensaje) {
    var dataJSON = {
        vcNomTip: vcNomTip,
        vcDesTip: vcDesTip,
...
function fnAgregarCamposMensajeAdjunto() {
    ...
    for (a = 0; a < rowsCampo.length; a++) {
        ...
        if (row.IdTipoDato == "9") {
            ...
            if (biExiste == 0) {
                Adjuntos.push({ IdCampo: row.IdCampo, vcNomCampo: row.Campo, vcCampo: row.Descripcion});
            } 
