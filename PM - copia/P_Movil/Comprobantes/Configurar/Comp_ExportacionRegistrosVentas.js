...
$(function () {
    ...
    function cargar_ubicacion(_IdTipoFuente, _Tipo) {
        ...
        $.ajax({
            type: "POST",
            url: "Comp_ExportacionRegistrosVentas.aspx/getListar_Ubicacion_ddl",
            data: JSON.stringify({
    ...
    function cargar_grillaDetalle(_IdConfigProceso, _Tipo) {
        ...
        if (_IdConfigProceso != "") {
            $.ajax({
                type: "POST",
                url: "Comp_ExportacionRegistrosVentas.aspx/getListar_DetalleUbicacion",
                data: JSON.stringify({
    ...
    function cargar_plantilla(_IdConfigProceso, _Tipo) {
        if (_IdConfigProceso != "") {
            ...
            $.ajax({
                type: "POST",
                url: "Comp_ExportacionRegistrosVentas.aspx/getListar_Plantilla_ddl",
                data: JSON.stringify({
                    'IdConfigProceso': _IdConfigProceso,
                    'Tipo': _Tipo,
                    'inTipOri': $("#hdfinTipOri").val()
    ...
    function Cargar_DetallePlantilla(_IdProceso) {
        ...
        $.ajax({
            type: "POST",
            url: "Comp_ExportacionRegistrosVentas.aspx/Listar_PlantillaDetalle",
            data: JSON.stringify({
    ...
    $("#btnGuardar").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "Comp_ExportacionRegistrosVentas.aspx/Insertar_ConfRegistroVentas",
            data: JSON.stringify({
