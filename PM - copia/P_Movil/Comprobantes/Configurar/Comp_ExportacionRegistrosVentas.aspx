<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Comp_ExportacionRegistrosVentas.aspx.vb" Inherits=".Comp_ExportacionRegistrosVentas" %>
...
<head runat="server">
    ...
    <script src="Comp_ExportacionRegistrosVentas.js" type="text/javascript"></script>
    <style type="text/css">
...
<body>
    ...
    <div class="dvPanel" style="overflow: auto; width: 700px;">
           <table> <tr> <td><h4 class="tblTitulos"> Programación  </h4> </td> <td valign="top" style="width:500px;"> <div style="float:right; display: none;"><ttgInfo:ToolTipGenerico ID="ttgInfoTipos" runat="server" /></div></td> </tr></table>
