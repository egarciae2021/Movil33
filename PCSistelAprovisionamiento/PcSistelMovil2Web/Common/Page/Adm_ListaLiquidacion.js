...
$(document).ready(function () {
    ...
    $("#txtconceptocobro").keypress(ValidarAlfaNumericoConEspacios);
...
$("#btnGuardarConceptoCobro").click(function () {
    ...
    if (Apr_ConceptoCobro.IdProducto == "-1") {
        alertaExterna("El producto es un campo obligatorio.");
        BloquearPagina(false);
        $("#ddlProducto").focus();
        return;
    }
...
function EditarRegistro() {
    ...
    if (id) {
        ...
        switch ($("#hdfvcTab").val()) {
            case "APR_TipoCobro":
                {
                    $("#hdfIdTipoCobro").val(datos.IdTipoCobro);
            ...
            case "APR_ConceptoCobro":
                {
                    $("#hdfIdConceptoCobro").val(datos.IdConceptoCobro);
                    $("#txtconceptocobro").val(datos.Nombre);
                    $("#ddlProducto").val(datos.IdProducto);

                    var digTipoCobro = $("#div_modal_conceptocobro").dialog({
                        title: 'Editar Concepto de Cobro',
                        width: 280,
                        height: 170,
                        modal: true,
                        resizable: false,
