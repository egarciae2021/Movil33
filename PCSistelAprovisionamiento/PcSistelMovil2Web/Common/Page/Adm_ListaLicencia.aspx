<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Adm_ListaLicencia.aspx.cs" Inherits="PcSistelMovil2Web.Common.Page.Adm_ListaLicencia" %>
...
<head id="Head1" runat="server">
    ...
    <script src="Adm_ListaLicencia.js"  type="text/javascript"></script>   
...
<body>
    ...
    <div id="div_modal_tipocobro" style="display:none; padding: 0px; margin: 0px; overflow-y: hidden;">
        <br />
        <table>
            <tr>
                <td class="style1">
                ...
                <td>
                    <asp:TextBox ID="txtDescripcion" runat="server" Width="180px"  MaxLength="200"></asp:TextBox>
                </td>
            </tr>
        </table>        
        <div id="dvModalAccionesTipoCobro" style="float:right; margin-top:30px;">
            <div id="btnGuardarTipoCobro" class="btnNormal" style="width: 100px;">                
                <asp:Image ID="Image4" runat="server"  ImageUrl="~/Common/images/save.ico" />
                    Guardar                
            </div>

            <div id="btnCerrarTipoCobro" class="btnNormal" style="width: 100px;">
    ...
    <div id="div_modal_conceptocobro" style="display:none; padding: 0px; margin: 0px; overflow-y: hidden;">
        <br />
        <table>
            <tr>
                <td class="style1">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtconceptocobro" runat="server" Width="180px"  MaxLength="200"></asp:TextBox>
                </td>
            </tr>
        </table>        
        <div id="dvModalAccionesConceptoCobro" style="float:right; margin-top:30px;">
            <div id="btnGuardarConceptoCobro" class="btnNormal" style="width: 100px;">
                <asp:Image ID="Image1" runat="server" Style="width: 20px; vertical-align: bottom;" ImageUrl="~/Common/images/save.ico" />
                Guardar
            </div>

            <div id="btnCerrarConceptoCobro" class="btnNormal" style="width: 100px;">
                <asp:Image ID="Image2" runat="server" Style="width: 20px; vertical-align: bottom;" ImageUrl="~/Common/Images/Mantenimiento/Salir.gif" />
                Cerrar
            </div>
        </div>
    </div>
                                        ...
                                        <td style="padding-right: 0px;">
                                            <table id="tblAcciones" runat="server" cellpadding="0" cellspacing="0">
                                                <tr>                                                
                                                    ...
                                                    <td>
                                                        <div id="btnEditar" class="btnNormal" runat="server" title="Editar Seleccionado" click="EditarRegistro">
