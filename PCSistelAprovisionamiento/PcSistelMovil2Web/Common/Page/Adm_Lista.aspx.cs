...
{
    public partial class Adm_Lista : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                else if (vcTab == "LIC_ContratoTermino")
                {
                    btnConfigurarFiltroRegistro.Visible = false;
                }
        ...
        public static string EliminarRegistro(string Id, string vcPar, string vcTab, string inTipOri, string btTipLog)
        {
            ...
            try
            {
                ...
                if (mensaje == "0")
                {
                    if (vcTab.ToUpper() == "APR_TIPOCOBRO") { return "Se Eliminó el registro de un Tipo de Cobro"; }
                    else if (vcTab.ToUpper() == "LIC_CONTRATOTERMINO")
                    {
                        return "Se eliminó (1) Registro(s) <br/> (Código(s): " + Id + ") "; 
                    }
                    else
                    {
                        return "Se desactivó (1) Registro(s) <br/> (Código(s): " + Id + ") ";
                ...
                {
                    return "No se puede eliminar el registro (<b><span style='color: red;'>" + Id + "</span></b>) porque fue creado por una solicitud. </br> Comuníquese con el área de Sistemas";
                }
                else
                {
