<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Adm_ListaLiquidacion.aspx.cs" Inherits="PcSistelMovil2Web.Common.Page.Adm_ListaLiquidacion" %>
...
<head id="Head1" runat="server">
    ...
    <link href="../Styles/JqueryThemeRoller/redmond/jquery-ui-1.8.16.custom.css" rel="stylesheet" type="text/css" />
    ...
    <link href="../Styles/Principal2.css" rel="stylesheet" type="text/css" />       
   
    <script src="Adm_ListaLiquidacion.js"  type="text/javascript"></script>                   
</head>
<body>
    ...
    <asp:HiddenField ID="hdfIdConceptoCobro" runat="server" />
    ...
    <div id="div_modal_tipocobro" style="display:none; padding: 0px; margin: 0px; margin-left:10px; overflow-y: hidden; text-align:center;">
        <br />
        <table>
            <tr>
                <td class="style1">
                ...
                <td>
                    <asp:TextBox ID="txtDescripcion" runat="server" Width="180px"  MaxLength="100"></asp:TextBox>
                </td>
            </tr>
        </table>        
        <div id="dvModalAccionesTipoCobro" style="float:none; margin-top:30px;" >
            
            <div id="btnGuardarTipoCobro" class="btnNormalLiquidacion" style="width: 100px;">
                <div class="btnDivLiquidaciones">
                    <asp:Image ID="Image3" runat="server" CssClass="btnImgLiquidacion" ImageUrl="~/Common/images/save.ico"  />
                    Guardar
                </div>
            </div>

            <div id="btnCerrarTipoCobro" class="btnNormalLiquidacion" style="width: 100px;">
                <div class="btnDivLiquidaciones">
                    <asp:Image ID="Image4" runat="server" CssClass="btnImgLiquidacion" ImageUrl="~/Common/Images/Mantenimiento/Salir.gif"  />
                    Cerrar
                </div>                
            </div>
    ...
    <div id="div_modal_conceptocobro" style="display:none; padding: 0px; margin: 0px; margin-left:10px; overflow-y: hidden; text-align:center;">
        <br />
        <table>
            <tr>
                <td class="style1">
                ...
                <td style="text-align:left;">
                    <%--                
                        <asp:DropDownList runat="server" ID="ddlProducto" CssClass="form_control">
                        </asp:DropDownList>
                    --%>                    
                    <select id="ddlProducto" class="form_control"></select>
                </td>
            </tr>
            <tr>
                <td class="style1">
                ...
                <td>
                    <asp:TextBox ID="txtconceptocobro" runat="server" Width="180px"  MaxLength="100"></asp:TextBox>
                </td>
            </tr>
        </table>        
        <div id="dvModalAccionesConceptoCobro" style="float:none; margin-top:30px;">

            <div id="btnGuardarConceptoCobro" class="btnNormalLiquidacion" style="width: 100px;">
                <div class="btnDivLiquidaciones">
                    <asp:Image ID="Image1" runat="server" CssClass="btnImgLiquidacion" ImageUrl="~/Common/images/save.ico"  />
                    Guardar
                </div>
            </div>

            <div id="btnCerrarConceptoCobro" class="btnNormalLiquidacion" style="width: 100px;">
                <div class="btnDivLiquidaciones">
                    <asp:Image ID="Image2" runat="server" CssClass="btnImgLiquidacion" ImageUrl="~/Common/Images/Mantenimiento/Salir.gif"  />
                    Cerrar
                </div>                
            </div>
                                        ...
                                        <td style="padding-right: 0px;">
                                            <table id="tblAcciones" runat="server" cellpadding="0" cellspacing="0">
                                                <tr>                                                
                                                    ...
                                                    <td>
                                                        <div id="btnEliminar" class="btnNormal" runat="server" title="Eliminar Seleccionados" click="EliminarRegistro">
