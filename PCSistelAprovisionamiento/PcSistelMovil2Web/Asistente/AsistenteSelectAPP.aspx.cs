...
{
    public partial class AsistenteSelectAPP : System.Web.UI.Page
    {
        ...
        [WebMethod()]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public static List<ENT_AP_InstanciaAPP> ListarInstanciaWEB(int IdServidorWeb)
        {
            BL_AP_InstanciaAPP InstanciaWEB = new BL_AP_InstanciaAPP();
            try
            {
                List<ENT_AP_InstanciaAPP> lstServidorWEB = InstanciaWEB.ListarxServidor(IdServidorWeb);
                return lstServidorWEB;
            }
            catch (Exception ex)
            {
