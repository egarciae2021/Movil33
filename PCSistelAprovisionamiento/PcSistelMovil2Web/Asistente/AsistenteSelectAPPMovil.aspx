<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AsistenteSelectAPPMovil.aspx.cs" Inherits="PcSistelMovil2Web.Asistente.AsistenteSelectAPPMovil" %>
...
<head runat="server">
    ...
    <script src="../Common/Scripts/Utilitario.js" type="text/javascript"></script>
    <script src="AsistenteSelectAPPMovil.js" type="text/javascript"></script>
</head>
<body>
    <form id="form1" runat="server">
    <asp:HiddenField ID="hdfServerAppMovil" runat="server" Value = "0" />
    <asp:HiddenField ID="hdfServerAppSecurity" runat="server" Value = "0" />
                    ...
                    <tr>
                        <td colspan="3">
                            <label style="color: #084B8A">
                                Selección de Servidor APPS</label>
                        </td>
                    </tr>
                </table>
                  ...
                  <tr>
                    <td>
                      <table style="width: 50%; text-align: left;">
                        <tr>
                            <td>
                                <div id="chartcontainerAPPA1" class="" style="padding: 5px 0px 0px 0px;">
                                </div>
                            </td>
                        </tr>
                      </table>
                      <asp:Label ID="Label1" runat="server" Text="Seleccione Instancia del Admin :"></asp:Label>
                      <asp:DropDownList ID="ddlInstanciaAPPA1" runat="server" CssClass="">
                      </asp:DropDownList>
                    </td>
                    ...
                    <td>
                      <table style="width: 50%;">
                        <tr>
                            <td>
                                <div id="chartcontainerAPPA2" class="" style="padding: 5px 0px 0px 0px;">
                                </div>
                            </td>
                        </tr>
                      </table>
                      <asp:Label ID="Label2" runat="server" Text="Seleccione Instancia de Pedido :"></asp:Label>
                      <asp:DropDownList ID="ddlInstanciaAPPA2" runat="server" CssClass="">
                      </asp:DropDownList>                    
                    </td>
