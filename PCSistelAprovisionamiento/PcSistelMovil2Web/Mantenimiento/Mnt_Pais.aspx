<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mnt_Pais.aspx.cs" Inherits="PcSistelMovil2Web.Mantenimiento.Mnt_Pais" %>
...
<body>
    <form id="form1" runat="server">
     <asp:HiddenField ID="hdfIdPais" runat="server" />
        ...
        <div id="dvdetalle" class="dvPanel" style="margin-left: 5px; margin-right: 5px; background">
            <table id="tbTipo" runat="server">
                ...
                <tr>
                    ...
                    <td class="ValorMant">
                        <asp:TextBox ID="txtCodigo" runat="server" Width="300px" MaxLength="50"></asp:TextBox>
                    </td>
                </tr>      
            </table>
            <br />
