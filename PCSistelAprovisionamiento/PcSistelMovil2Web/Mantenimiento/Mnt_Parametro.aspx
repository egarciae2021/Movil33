<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mnt_Parametro.aspx.cs" Inherits="PcSistelMovil2Web.Mantenimiento.Mnt_Parametro" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script src="Mnt_Parametro.js" type="text/javascript"></script>
</head>
<body>
    <form id="form1" runat="server">
     <asp:HiddenField ID="hdfIdParametro" runat="server" />
    ...
    <div>
        ...
        <div id="dvdetalle" class="dvPanel" style="margin-left: 5px; margin-right: 5px; background">
            <table id="tbTipo" runat="server">
                ...
                <tr>
                    <td class="TituloMant">
                        <asp:Label ID="Label2" runat="server" Text="Nombre Parametro"></asp:Label>
                    </td>
                    <td class="ValorMant">
                        <asp:TextBox ID="txtParametro" runat="server" Width="300px" MaxLength="50"></asp:TextBox>
                    </td>
                </tr>
