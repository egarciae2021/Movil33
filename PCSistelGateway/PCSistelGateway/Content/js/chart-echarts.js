                ...
                series: [
                    ...
                    },
                    {
                        ...
                        itemStyle: {
                          normal: {
                            color:'#00C6D7', 
                            borderWidth:2, borderColor:'#00C6D7', 
                            areaStyle: {color:'#00C6D7', type: 'default'}
                          }
                        },
...
var option_dt = {
    ...
    options : [
        {
            color: ['#003245','#303F9F','#1A237E','#9FA8DA','#7986CB','#C5CAE9'],
            title : {
                text: '',
                subtext: ''
            },
            ...
            legend: {
                ...
                orient:'vertical',
                padding: 0,
                data:['Apple','One Plus','Samsung','HTC','Otros']
            },
            toolbox: {
                show : true,
                color : ['#bdbdbd','#bdbdbd','#bdbdbd','#bdbdbd'],
                            ...
                            series : [
                                {
                                    ...
                                    data:[{value: 35,  name:'Apple'}, {value: 16,  name:'One Plus'}, {value: 27,  name:'HTC'}, {value: 29,  name:'Samsung'}, {value: 12,  name:'Otros'}]
                                }
                            ]
                    }, 
                {
                    series : [
                        {
                            name:'05-16',
                            type:'pie',
                            data:[{value: 42,  name:'Apple'}, {value: 51,  name:'One Plus'}, {value: 39,  name:'HTC'}, {value: 25,  name:'Samsung'}, {value: 9,  name:'Otros'}]
                        }
                    ]
                },
                {
                    series : [
                        {
                            name:'04-16',
                            type:'pie',
                            data:[{value: 29,  name:'Apple'}, {value: 16,  name:'One Plus'}, {value: 24,  name:'HTC'}, {value: 19,  name:'Samsung'}, {value: 5,  name:'Otros'}]
                        }
                    ]
                },
...
// Initialize after dom ready
        ...
        var option = {
            color: ['rgba(63,81,181,1.0)','#00C6D7'],
    title : {
       // text: '',
       // subtext: ''
    },
