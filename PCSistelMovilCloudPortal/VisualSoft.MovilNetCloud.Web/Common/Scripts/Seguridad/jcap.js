...
//var imgdir = "Common/Scripts/cimg/"; // identify directory where captcha images are located
var imgdir = window.location + "/Common/Images/cimg/";
imgdir = imgdir.replace("Login/AccesoTDP/", "");
...
function sjcap(jfldcls) {
    ...
    imgid = parseInt(anum);
    cword = ["60ee0bc62638fccf2d37ac27a634a9e9", "68e2d83709f317938b51e53f7552ed04", "f4c9385f1902f7334b00b9b4ecd164de",
    ...
    document.write("<input type=\"text\" id=\"" + jfldid + "\" class=\"fields form-control\" name=\"" + jfldid + "\" class=\"" + jfldcls + "\" placeholder=\"C&oacute;digo\" size=\"" + jfldsz + "\">");
    document.write("<img id=\"img-jcap\" src=\"" + decodeURIComponent(imgdir) + imgid + ".jpg\" width=\"270\" height=\"80\" alt=\"\" >");

    //document.write("<td style=\"font-weight:bold; font-size:11px;\" align='right'>C&oacute;digo:</td><td><input type=\"text\" id=\"" + jfldid + "\" class=\"fields form-control\" name=\"" + jfldid + "\" class=\"" + jfldcls + "\" size=\"" + jfldsz + "\"></td></tr><tr></tr><tr>");
    //document.write("<td colspan='2' ><img src=\"" + decodeURIComponent(imgdir) + imgid + ".jpg\" width=\"290\" height=\"80\" alt=\"\"></td>");
}
...
function jcap() {
    ...
    if (uword == cword[anum - 1]) {
        ...
        //alerta("ERROR: Enter the code as it is shown.");
