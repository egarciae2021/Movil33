...
$(function () {
    ...
    function ProbarConexion(Autenticacion, Servidor, Usuario, Password, BaseDatos) {
        $.ajax({
            type: "POST",
            url: "Common/WebServices/General.asmx/ComprobarConexion",
    ...
    $("#btnGuardar").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "Common/WebServices/General.asmx/GuardarConfiguracionBase",
    ...
    $("#btnCargarDatosBase").click(function () {
        $.ajax({
            type: "POST",
            url: "Common/WebServices/General.asmx/CargarConfiguracionDatos",
            data: "{}",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (result) {
    ...
    $("#btnGuardarDatos").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "Common/WebServices/General.asmx/GuardarConfiguracionDatos",
