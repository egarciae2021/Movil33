$(function () {
    ...
    $("#btnEnviar").click(function () {
        ...
        $.ajax({
            ...
            data: "{'CodigoSolicitud': '" + $("#hdfCodReestablecimiento").val() + "'," +
                "'NuevaContrasena': '" + vPass1 + "'," +
                "'ConfirmacionContrasena': '" + vPass2 + "'," +
                "'PaginaLogin': '" + fnObtenerPaginaLogin() + "'," +
                "'IdDominio': '" + $("#hdfIdDominio").val() + "'}",
