...
Partial Public Class CronogramaPagos
    ...
    '''<summary>
    '''Control eegCronograma.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents eegCronograma As Global.WebSiteCliente.ExportarExcelGenerico
End Class
