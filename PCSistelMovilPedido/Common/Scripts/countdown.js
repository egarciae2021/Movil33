...
function(module) {
	...
	var resetLabels = countdown.resetLabels = function() {
		LABELS_SINGLUAR = 'millisecond|segundo|minuto|hora|dia|semana|mes|año|decada|century|millennium'.split('|');
		LABELS_PLURAL = 'milliseconds|segundos|minutos|horas|dias|semanas|meses|años|decadas|centuries|millennia'.split('|');
	};
